-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_SKYBORNE_38_WESTERN_PLAGUELANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_SKYBORNE_38_WESTERN_PLAGUELANDS",
    name = "38. Western Plaguelands 52-53 (Skyborne)",
    version = 2,
    faction = "Horde",
    race = { "Skyborne" },
    minLevel = 52,
    ...
    next = "GEN_HORDE_SKYBORNE_39_EASTERN_PLAGUELANDS",
    author = "ForeverGuide route planner",
    notes = "Chapter 38 of the Skyborne route: level 52 to 53, 13 steps, ~261 min of play in the model (8074 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
        ...
        { type = "GRIND", npc = 1817, target = "Diseased Wolf", level = 53, map = 1422, zone = "Western Plaguelands", x = 44.8, y = 44.8, near = true, note = "grind Diseased Wolf (level 53-54) to level 53 - nothing worth questing at 52" }, -- 13
    },
})
