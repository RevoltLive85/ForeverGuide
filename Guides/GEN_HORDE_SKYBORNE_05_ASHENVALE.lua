...
ns.RegisterGuide({
    ...
    name = "5. Ashenvale 26-28 (Skyborne)",
    version = 2,
    faction = "Horde",
    race = { "Skyborne" },
    minLevel = 26,
    ...
    notes = "Chapter 5 of the Skyborne route: level 26 to 28, 39 steps, ~112 min of play in the model (22804 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
