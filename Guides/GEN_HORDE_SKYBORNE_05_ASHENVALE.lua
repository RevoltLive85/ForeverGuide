-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_SKYBORNE_05_ASHENVALE.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_SKYBORNE_05_ASHENVALE",
    name = "5. Ashenvale 26-27 (Skyborne)",
    version = 2,
    faction = "Horde",
    race = { "Skyborne" },
    minLevel = 26,
    ...
    map = 1440,
    zone = "Ashenvale",
    next = "GEN_HORDE_SKYBORNE_06_THOUSAND_NEEDLES",
    author = "ForeverGuide route planner",
    notes = "Chapter 5 of the Skyborne route: level 26 to 27, 39 steps, ~114 min of play in the model (22615 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
