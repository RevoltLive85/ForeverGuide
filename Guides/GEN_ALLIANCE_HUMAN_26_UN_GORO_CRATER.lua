...
ns.RegisterGuide({
    ...
    notes = "Chapter 26 of the Human route: level 47 to 47, 27 steps, ~100 min of play in the model (29139 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 27,
