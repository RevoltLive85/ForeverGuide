...
ns.RegisterGuide({
    ...
    name = "47. Winterspring 56-58 (Skyborne)",
    version = 2,
    faction = "Alliance",
    race = { "Skyborne" },
    minLevel = 56,
    ...
    map = 1452,
    zone = "Winterspring",
    next = "GEN_ALLIANCE_SKYBORNE_48_SILITHUS",
    author = "ForeverGuide route planner",
    notes = "Chapter 47 of the Skyborne route: level 56 to 58, 9 steps, ~549 min of play in the model (1981 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
