...
ns.RegisterGuide({
    ...
    notes = "Chapter 4 of the Orc route: level 24 to 25, 39 steps, ~124 min of play in the model (22550 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
