...
ns.RegisterGuide({
    ...
    map = 1449,
    zone = "Un'Goro Crater",
    next = "GEN_HORDE_ORC_26_TANARIS",
    author = "ForeverGuide route planner",
    notes = "Chapter 25 of the Orc route: level 48 to 48, 13 steps, ~48 min of play in the model (47134 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
