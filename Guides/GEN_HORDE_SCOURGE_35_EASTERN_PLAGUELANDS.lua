-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_SCOURGE_35_EASTERN_PLAGUELANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_SCOURGE_35_EASTERN_PLAGUELANDS",
    name = "35. Eastern Plaguelands 50-50 (Undead)",
    version = 2,
    faction = "Horde",
    race = { "Scourge" },
    minLevel = 50,
    ...
    next = "GEN_HORDE_SCOURGE_36_UN_GORO_CRATER",
    author = "ForeverGuide route planner",
    notes = "Chapter 35 of the Scourge route: level 50 to 50, 6 steps, ~15 min of play in the model (35837 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
