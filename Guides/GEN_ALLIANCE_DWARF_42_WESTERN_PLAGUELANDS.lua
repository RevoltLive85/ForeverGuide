-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_DWARF_42_WESTERN_PLAGUELANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    ...
    next = "GEN_ALLIANCE_DWARF_43_WINTERSPRING",
    author = "ForeverGuide route planner",
    notes = "Chapter 42 of the Dwarf route: level 53 to 53, 7 steps, ~17 min of play in the model (54042 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 7,
