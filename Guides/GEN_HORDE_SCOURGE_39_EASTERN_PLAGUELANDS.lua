...
ns.RegisterGuide({
    ...
    next = "GEN_HORDE_SCOURGE_40_WINTERSPRING",
    author = "ForeverGuide route planner",
    notes = "Chapter 39 of the Scourge route: level 52 to 52, 16 steps, ~83 min of play in the model (39868 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
