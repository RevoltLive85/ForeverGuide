-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_SKYBORNE_37_EASTERN_PLAGUELANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_SKYBORNE_37_EASTERN_PLAGUELANDS",
    name = "37. Eastern Plaguelands 52-52 (Skyborne)",
    version = 2,
    faction = "Horde",
    race = { "Skyborne" },
    minLevel = 52,
    ...
    next = "GEN_HORDE_SKYBORNE_38_WINTERSPRING",
    author = "ForeverGuide route planner",
    notes = "Chapter 37 of the Skyborne route: level 52 to 52, 16 steps, ~83 min of play in the model (39868 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
