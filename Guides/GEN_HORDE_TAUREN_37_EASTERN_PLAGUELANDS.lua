...
ns.RegisterGuide({
    ...
    name = "37. Eastern Plaguelands 52-52 (Tauren)",
    version = 2,
    faction = "Horde",
    race = { "Tauren" },
    minLevel = 52,
    ...
    next = "GEN_HORDE_TAUREN_38_WINTERSPRING",
    author = "ForeverGuide route planner",
    notes = "Chapter 37 of the Tauren route: level 52 to 52, 16 steps, ~83 min of play in the model (39868 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
