-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_SCOURGE_26_FELWOOD.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_SCOURGE_26_FELWOOD",
    name = "26. Felwood 48-48 (Undead)",
    version = 2,
    faction = "Horde",
    race = { "Scourge" },
    minLevel = 48,
    ...
    notes = "Chapter 26 of the Scourge route: level 48 to 48, 22 steps, ~91 min of play in the model (39924 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
