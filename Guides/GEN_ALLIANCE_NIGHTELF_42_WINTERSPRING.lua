...
ns.RegisterGuide({
    ...
    name = "42. Winterspring 53-54 (Night Elf)",
    version = 2,
    faction = "Alliance",
    race = { "NightElf" },
    minLevel = 53,
    ...
    map = 1452,
    zone = "Winterspring",
    next = "GEN_ALLIANCE_NIGHTELF_43_SILITHUS",
    author = "ForeverGuide route planner",
    notes = "Chapter 42 of the NightElf route: level 53 to 54, 13 steps, ~239 min of play in the model (4427 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
