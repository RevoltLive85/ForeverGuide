...
ns.RegisterGuide({
    ...
    notes = "Chapter 33 of the Orc route: level 50 to 51, 8 steps, ~160 min of play in the model (39833 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
