...
ns.RegisterGuide({
    ...
    notes = "Chapter 42 of the Orc route: level 55 to 55, 34 steps, ~149 min of play in the model (56785 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
