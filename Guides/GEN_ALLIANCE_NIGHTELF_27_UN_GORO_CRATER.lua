...
ns.RegisterGuide({
    ...
    name = "27. Un'Goro Crater 46-46 (Night Elf)",
    version = 2,
    faction = "Alliance",
    race = { "NightElf" },
    minLevel = 46,
    ...
    map = 1449,
    zone = "Un'Goro Crater",
    next = "GEN_ALLIANCE_NIGHTELF_28_TANARIS",
    author = "ForeverGuide route planner",
    notes = "Chapter 27 of the NightElf route: level 46 to 46, 27 steps, ~74 min of play in the model (39406 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
