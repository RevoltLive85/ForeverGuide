-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_NIGHTELF_27_UN_GORO_CRATER.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_ALLIANCE_NIGHTELF_27_UN_GORO_CRATER",
    name = "27. Un'Goro Crater 47-47 (Night Elf)",
    version = 2,
    faction = "Alliance",
    race = { "NightElf" },
    minLevel = 47,
    ...
    map = 1449,
    zone = "Un'Goro Crater",
    next = "GEN_ALLIANCE_NIGHTELF_28_AZSHARA",
    author = "ForeverGuide route planner",
    notes = "Chapter 27 of the NightElf route: level 47 to 47, 27 steps, ~102 min of play in the model (28565 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 27,
