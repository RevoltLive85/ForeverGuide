-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_DWARF_38_EASTERN_PLAGUELANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_ALLIANCE_DWARF_38_EASTERN_PLAGUELANDS",
    name = "38. Eastern Plaguelands 52-52 (Dwarf)",
    version = 2,
    faction = "Alliance",
    race = { "Dwarf", "Gnome" },
    minLevel = 52,
    ...
    next = "GEN_ALLIANCE_DWARF_39_WINTERSPRING",
    author = "ForeverGuide route planner",
    notes = "Chapter 38 of the Dwarf route: level 52 to 52, 20 steps, ~98 min of play in the model (39384 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
