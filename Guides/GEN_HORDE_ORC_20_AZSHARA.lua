...
ns.RegisterGuide({
    ...
    notes = "Chapter 20 of the Orc route: level 46 to 46, 25 steps, ~97 min of play in the model (32412 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 25,
