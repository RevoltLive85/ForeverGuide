...
ns.RegisterGuide({
    ...
    notes = "Chapter 32 of the Orc route: level 50 to 50, 14 steps, ~40 min of play in the model (44266 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 14,
