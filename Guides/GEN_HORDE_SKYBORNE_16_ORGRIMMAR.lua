...
ns.RegisterGuide({
    ...
    notes = "Chapter 16 of the Skyborne route: level 43 to 44, 10 steps, ~18 min of play in the model (56149 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 10,
