-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_ORC_34_EASTERN_PLAGUELANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_ORC_34_EASTERN_PLAGUELANDS",
    name = "34. Eastern Plaguelands 51-51 (Orc)",
    version = 2,
    faction = "Horde",
    race = { "Orc", "Troll" },
    minLevel = 51,
    ...
    next = "GEN_HORDE_ORC_35_UN_GORO_CRATER",
    author = "ForeverGuide route planner",
    notes = "Chapter 34 of the Orc route: level 51 to 51, 6 steps, ~15 min of play in the model (35837 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
