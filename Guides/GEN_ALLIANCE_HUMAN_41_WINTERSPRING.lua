-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_HUMAN_41_WINTERSPRING.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_ALLIANCE_HUMAN_41_WINTERSPRING",
    name = "41. Winterspring 51-52 (Human)",
    version = 2,
    faction = "Alliance",
    race = { "Human" },
    minLevel = 51,
    ...
    map = 1452,
    zone = "Winterspring",
    next = "GEN_ALLIANCE_HUMAN_42_UN_GORO_CRATER",
    author = "ForeverGuide route planner",
    notes = "Chapter 41 of the Human route: level 51 to 52, 27 steps, ~91 min of play in the model (42776 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
