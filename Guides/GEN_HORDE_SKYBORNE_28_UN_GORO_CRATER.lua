-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_SKYBORNE_28_UN_GORO_CRATER.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_SKYBORNE_28_UN_GORO_CRATER",
    name = "28. Un'Goro Crater 49-49 (Skyborne)",
    version = 2,
    faction = "Horde",
    race = { "Skyborne" },
    minLevel = 49,
    ...
    map = 1449,
    zone = "Un'Goro Crater",
    next = "GEN_HORDE_SKYBORNE_29_THE_HINTERLANDS",
    author = "ForeverGuide route planner",
    notes = "Chapter 28 of the Skyborne route: level 49 to 49, 13 steps, ~68 min of play in the model (32368 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
