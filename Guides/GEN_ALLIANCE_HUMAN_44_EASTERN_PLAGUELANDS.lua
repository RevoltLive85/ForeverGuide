-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_HUMAN_44_EASTERN_PLAGUELANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_ALLIANCE_HUMAN_44_EASTERN_PLAGUELANDS",
    name = "44. Eastern Plaguelands 54-54 (Human)",
    version = 2,
    faction = "Alliance",
    race = { "Human" },
    minLevel = 54,
    ...
    next = "GEN_ALLIANCE_HUMAN_45_WESTERN_PLAGUELANDS",
    author = "ForeverGuide route planner",
    notes = "Chapter 44 of the Human route: level 54 to 54, 42 steps, ~182 min of play in the model (55388 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
