...
ns.RegisterGuide({
    ...
    notes = "Chapter 12 of the Skyborne route: level 30 to 31, 39 steps, ~125 min of play in the model (30066 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 39,
    steps = function() return {
        ...
        { type = "ACCEPT", quest = 681, questName = "Northfold Manor", npc = 2700, npcName = "Captain Nials", map = 1417, zone = "Arathi Highlands", x = 45.8, y = 47.6 }, -- 4
        { type = "ACCEPT", quest = 8260, questName = "Arathor Basic Care Package", npc = 15127, npcName = "Samuel Hawke", map = 1417, zone = "Arathi Highlands", x = 46, y = 45.2 }, -- 5
        ...
        { type = "TURNIN", quest = 8168, questName = "The Battle for Arathi Basin!", npc = 14983, npcName = "Field Marshal Oslight", map = 1417, zone = "Arathi Highlands", x = 45.8, y = 45.5 }, -- 7
        ...
        { type = "TURNIN", quest = 659, questName = "Hints of a New Plague?", npc = 2712, npcName = "Quae", map = 1417, zone = "Arathi Highlands", x = 60.2, y = 53.9 }, -- 26
        { type = "ACCEPT", quest = 658, questName = "Hints of a New Plague?", npc = 2712, npcName = "Quae", map = 1417, zone = "Arathi Highlands", x = 60.2, y = 53.9 }, -- 27
        { type = "COLLECT", quest = 651, questName = "Stones of Binding", target = "Thundering Key", map = 1417, zone = "Arathi Highlands", x = 52, y = 50.7 }, -- 28
        { type = "COLLECT", quest = 658, questName = "Hints of a New Plague?", target = "Sealed Folder", map = 1417, zone = "Arathi Highlands", x = 52.5, y = 61.5, near = true }, -- 29
        { type = "TURNIN", quest = 658, questName = "Hints of a New Plague?", npc = 2712, npcName = "Quae", map = 1417, zone = "Arathi Highlands", x = 60.2, y = 53.9 }, -- 30
        { type = "ACCEPT", quest = 657, questName = "Hints of a New Plague?", npc = 2712, npcName = "Quae", map = 1417, zone = "Arathi Highlands", x = 60.2, y = 53.9 }, -- 31
        { type = "TURNIN", quest = 657, questName = "Hints of a New Plague?", npc = 2713, npcName = "Kinelory", map = 1417, zone = "Arathi Highlands", x = 60.2, y = 53.9 }, -- 32
        { type = "ACCEPT", quest = 660, questName = "Hints of a New Plague?", npc = 2713, npcName = "Kinelory", map = 1417, zone = "Arathi Highlands", x = 60.2, y = 53.9 }, -- 33
        { type = "COMPLETE", quest = 660, questName = "Hints of a New Plague?", target = "Protect Kinelory", map = 1417, zone = "Arathi Highlands", x = 60.1, y = 53.8, note = "Protect Kinelory" }, -- 34
        { type = "TURNIN", quest = 660, questName = "Hints of a New Plague?", npc = 2712, npcName = "Quae", map = 1417, zone = "Arathi Highlands", x = 60.2, y = 53.9 }, -- 35
        { type = "ACCEPT", quest = 661, questName = "Hints of a New Plague?", npc = 2712, npcName = "Quae", map = 1417, zone = "Arathi Highlands", x = 60.2, y = 53.9 }, -- 36
