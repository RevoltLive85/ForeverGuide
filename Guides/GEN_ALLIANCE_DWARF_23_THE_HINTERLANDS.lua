...
ns.RegisterGuide({
    ...
    name = "23. The Hinterlands 41-44 (Dwarf)",
    version = 2,
    faction = "Alliance",
    race = { "Dwarf", "Gnome" },
    minLevel = 41,
    ...
    notes = "Chapter 23 of the Dwarf route: level 41 to 44, 19 steps, ~459 min of play in the model (3446 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
