...
ns.RegisterGuide({
    ...
    notes = "Chapter 23 of the Dwarf route: level 42 to 45, 18 steps, ~473 min of play in the model (10475 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 18,
