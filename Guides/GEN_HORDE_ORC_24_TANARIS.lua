...
ns.RegisterGuide({
    ...
    notes = "Chapter 24 of the Orc route: level 48 to 48, 19 steps, ~56 min of play in the model (39738 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps (1 here).",
    stepCount = 19,
