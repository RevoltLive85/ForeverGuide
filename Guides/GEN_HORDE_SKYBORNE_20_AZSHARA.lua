-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_SKYBORNE_20_AZSHARA.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_SKYBORNE_20_AZSHARA",
    name = "20. Azshara 46-46 (Skyborne)",
    version = 2,
    faction = "Horde",
    race = { "Skyborne" },
    minLevel = 46,
    ...
    map = 1447,
    zone = "Azshara",
    next = "GEN_HORDE_SKYBORNE_21_FELWOOD",
    author = "ForeverGuide route planner",
    notes = "Chapter 20 of the Skyborne route: level 46 to 46, 25 steps, ~97 min of play in the model (32412 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 25,
