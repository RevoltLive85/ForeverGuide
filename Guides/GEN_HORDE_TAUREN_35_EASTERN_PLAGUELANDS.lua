-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_TAUREN_35_EASTERN_PLAGUELANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_TAUREN_35_EASTERN_PLAGUELANDS",
    name = "35. Eastern Plaguelands 51-51 (Tauren)",
    version = 2,
    faction = "Horde",
    race = { "Tauren" },
    minLevel = 51,
    ...
    next = "GEN_HORDE_TAUREN_36_UN_GORO_CRATER",
    author = "ForeverGuide route planner",
    notes = "Chapter 35 of the Tauren route: level 51 to 51, 6 steps, ~15 min of play in the model (35837 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
