-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_NIGHTELF_40_EASTERN_PLAGUELANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_ALLIANCE_NIGHTELF_40_EASTERN_PLAGUELANDS",
    name = "40. Eastern Plaguelands 52-53 (Night Elf)",
    version = 2,
    faction = "Alliance",
    race = { "NightElf" },
    minLevel = 52,
    ...
    next = "GEN_ALLIANCE_NIGHTELF_41_WESTERN_PLAGUELANDS",
    author = "ForeverGuide route planner",
    notes = "Chapter 40 of the NightElf route: level 52 to 53, 21 steps, ~212 min of play in the model (18103 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
        ...
        { type = "GRIND", npc = 8596, target = "Plaguehound Runt", level = 53, map = 1423, zone = "Eastern Plaguelands", x = 7.7, y = 53.9, near = true, note = "grind Plaguehound Runt (level 53-54) to level 53 - nothing worth questing at 52" }, -- 21
    },
})
