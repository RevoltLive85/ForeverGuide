...
ns.RegisterGuide({
    ...
    notes = "Chapter 40 of the NightElf route: level 52 to 53, 24 steps, ~212 min of play in the model (18103 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps (1 here).",
    stepCount = 24,
