-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_DWARF_44_EASTERN_PLAGUELANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_ALLIANCE_DWARF_44_EASTERN_PLAGUELANDS",
    name = "44. Eastern Plaguelands 55-55 (Dwarf)",
    version = 2,
    faction = "Alliance",
    race = { "Dwarf", "Gnome" },
    minLevel = 55,
    ...
    next = "GEN_ALLIANCE_DWARF_45_WESTERN_PLAGUELANDS",
    author = "ForeverGuide route planner",
    notes = "Chapter 44 of the Dwarf route: level 55 to 55, 42 steps, ~170 min of play in the model (58430 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
