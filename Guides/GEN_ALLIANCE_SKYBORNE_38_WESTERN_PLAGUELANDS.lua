-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_SKYBORNE_38_WESTERN_PLAGUELANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_ALLIANCE_SKYBORNE_38_WESTERN_PLAGUELANDS",
    name = "38. Western Plaguelands 52-52 (Skyborne)",
    version = 2,
    faction = "Alliance",
    race = { "Skyborne" },
    minLevel = 52,
    ...
    next = "GEN_ALLIANCE_SKYBORNE_39_EASTERN_PLAGUELANDS",
    author = "ForeverGuide route planner",
    notes = "Chapter 38 of the Skyborne route: level 52 to 52, 8 steps, ~41 min of play in the model (39039 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 8,
