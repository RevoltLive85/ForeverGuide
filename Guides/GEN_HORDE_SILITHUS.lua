-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_SILITHUS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_SILITHUS",
    name = "Silithus 55-60 (Horde)",
    version = 1,
    faction = "Horde",
    minLevel = 55,
    maxLevel = 60,
    ...
    steps = {
        ...
        { type = "ACCEPT", quest = 8277, questName = "Deadly Desert Venom", npc = 15189, npcName = "Beetix Ficklespragg", map = 1451, zone = "Silithus", x = 51.6, y = 38.6 }, -- 2
        { type = "ACCEPT", quest = 8284, questName = "The Twilight Mystery", npc = 15183, npcName = "Geologist Larksbane", map = 1451, zone = "Silithus", x = 49.7, y = 37.5 }, -- 3
        { type = "ACCEPT", quest = 8283, questName = "Wanted - Deathclasp, Terror of the Sands", map = 1451, zone = "Silithus", x = 51.4, y = 38.3, optional = true, note = "elite target - bring a group (optional)" }, -- 4
        { type = "ACCEPT", quest = 9416, questName = "Report to General Kirika", npc = 17081, npcName = "Scout Bloodfist", map = 1451, zone = "Silithus", x = 49, y = 36.7 }, -- 5
        { type = "KILL", quest = 8277, questName = "Deadly Desert Venom", npc = 11738, target = "Sand Skitterer", map = 1451, zone = "Silithus", x = 42.3, y = 35.1, near = true, note = "loot Sand Skitterer Fang" }, -- 6
        { type = "KILL", quest = 8280, questName = "Securing the Supply Lines", npc = 11740, target = "Dredge Striker", map = 1451, zone = "Silithus", x = 38.2, y = 34.3, near = true }, -- 7
        { type = "KILL", quest = 8277, questName = "Deadly Desert Venom", npc = 11735, target = "Stonelash Scorpid", map = 1451, zone = "Silithus", x = 43, y = 41.2, near = true, note = "loot Stonelash Scorpid Stinger" }, -- 8
        ...
        { type = "KILL", quest = 8278, questName = "Noggle's Last Hope", npc = 11737, target = "Stonelash Flayer", map = 1451, zone = "Silithus", x = 49.5, y = 66.6, near = true, note = "loot Stonelash Flayer Stinger" }, -- 16
        { type = "ACCEPT", quest = 9422, questName = "Scouring the Desert", npc = 17079, npcName = "General Kirika", map = 1451, zone = "Silithus", x = 50.8, y = 69.5 }, -- 17
        { type = "TURNIN", quest = 9416, questName = "Report to General Kirika", npc = 17079, npcName = "General Kirika", map = 1451, zone = "Silithus", x = 50.8, y = 69.5 }, -- 18
        { type = "KILL", quest = 8278, questName = "Noggle's Last Hope", npc = 11739, target = "Rock Stalker", map = 1451, zone = "Silithus", x = 50.4, y = 69.8, near = true, note = "loot Rock Stalker Fang" }, -- 19
        { type = "KILL", quest = 9422, questName = "Scouring the Desert", npc = 18199, target = "Silithus Dust Turnin Quest Doodad Horde", map = 1451, zone = "Silithus", x = 50.9, y = 69.3 }, -- 20
        { type = "TURNIN", quest = 9422, questName = "Scouring the Desert", npc = 17079, npcName = "General Kirika", map = 1451, zone = "Silithus", x = 50.8, y = 69.5 }, -- 21
        ...
        { type = "COLLECT", quest = 8323, questName = "True Believers", target = "Encrypted Twilight Text", map = 1451, zone = "Silithus", x = 41.5, y = 45.2, near = true }, -- 39
        ...
        { type = "ACCEPT", quest = 8318, questName = "Secret Communication", npc = 15306, npcName = "Bor Wildmane", map = 1451, zone = "Silithus", x = 48.6, y = 37.8 }, -- 41
        { type = "COLLECT", quest = 8318, questName = "Secret Communication", target = "Encrypted Twilight Text", map = 1451, zone = "Silithus", x = 40.9, y = 42.2, near = true }, -- 42
