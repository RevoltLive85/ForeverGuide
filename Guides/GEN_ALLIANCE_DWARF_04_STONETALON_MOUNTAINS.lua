-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_DWARF_04_STONETALON_MOUNTAINS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_ALLIANCE_DWARF_04_STONETALON_MOUNTAINS",
    name = "4. Stonetalon Mountains 16-17 (Dwarf)",
    version = 2,
    faction = "Alliance",
    race = { "Dwarf", "Gnome" },
    minLevel = 16,
    ...
    notes = "Chapter 4 of the Dwarf route: level 16 to 17, 17 steps, ~35 min of play in the model (21060 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
