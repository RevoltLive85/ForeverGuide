...
ns.RegisterGuide({
    ...
    notes = "Chapter 44 of the Orc route: level 56 to 56, 13 steps, ~54 min of play in the model (26887 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
