...
ns.RegisterGuide({
    ...
    name = "14. Arathi Highlands 33-34 (Dwarf)",
    version = 2,
    faction = "Alliance",
    race = { "Dwarf", "Gnome" },
    minLevel = 33,
    ...
    next = "GEN_ALLIANCE_DWARF_15_DUSTWALLOW_MARSH",
    author = "ForeverGuide route planner",
    notes = "Chapter 14 of the Dwarf route: level 33 to 34, 37 steps, ~108 min of play in the model (34202 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 37,
