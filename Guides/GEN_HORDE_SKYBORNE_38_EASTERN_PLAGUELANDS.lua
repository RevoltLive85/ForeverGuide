...
ns.RegisterGuide({
    ...
    name = "38. Eastern Plaguelands 54-54 (Skyborne)",
    version = 2,
    faction = "Horde",
    race = { "Skyborne" },
    minLevel = 54,
    ...
    next = "GEN_HORDE_SKYBORNE_39_SILITHUS",
    author = "ForeverGuide route planner",
    notes = "Chapter 38 of the Skyborne route: level 54 to 54, 20 steps, ~81 min of play in the model (50154 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 20,
