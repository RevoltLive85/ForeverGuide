-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_SKYBORNE_08_STRANGLETHORN_VALE.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_SKYBORNE_08_STRANGLETHORN_VALE",
    name = "8. Stranglethorn Vale 30-36 (Skyborne)",
    version = 2,
    faction = "Horde",
    race = { "Skyborne" },
    minLevel = 30,
    ...
    next = "GEN_HORDE_SKYBORNE_09_BADLANDS",
    author = "ForeverGuide route planner",
    notes = "Chapter 8 of the Skyborne route: level 30 to 36, 97 steps, ~854 min of play in the model (25842 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
