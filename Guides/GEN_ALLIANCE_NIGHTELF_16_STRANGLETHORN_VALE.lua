...
ns.RegisterGuide({
    ...
    notes = "Chapter 16 of the NightElf route: level 37 to 37, 29 steps, ~103 min of play in the model (27519 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps (1 here).",
    stepCount = 29,
