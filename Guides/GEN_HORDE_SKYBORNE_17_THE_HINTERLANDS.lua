...
ns.RegisterGuide({
    ...
    notes = "Chapter 17 of the Skyborne route: level 44 to 45, 37 steps, ~187 min of play in the model (37693 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
