-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_TAUREN_14_FERALAS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_TAUREN_14_FERALAS",
    name = "14. Feralas 41-42 (Tauren)",
    version = 2,
    faction = "Horde",
    race = { "Tauren" },
    minLevel = 41,
    ...
    map = 1444,
    zone = "Feralas",
    next = "GEN_HORDE_TAUREN_15_DESOLACE",
    author = "ForeverGuide route planner",
    notes = "Chapter 14 of the Tauren route: level 41 to 42, 44 steps, ~171 min of play in the model (39160 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 44,
