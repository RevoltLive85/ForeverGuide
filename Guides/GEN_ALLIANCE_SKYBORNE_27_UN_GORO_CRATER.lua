-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_SKYBORNE_27_UN_GORO_CRATER.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_ALLIANCE_SKYBORNE_27_UN_GORO_CRATER",
    name = "27. Un'Goro Crater 47-47 (Skyborne)",
    version = 2,
    faction = "Alliance",
    race = { "Skyborne" },
    minLevel = 47,
    ...
    map = 1449,
    zone = "Un'Goro Crater",
    next = "GEN_ALLIANCE_SKYBORNE_28_TANARIS",
    author = "ForeverGuide route planner",
    notes = "Chapter 27 of the Skyborne route: level 47 to 47, 27 steps, ~72 min of play in the model (40170 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
