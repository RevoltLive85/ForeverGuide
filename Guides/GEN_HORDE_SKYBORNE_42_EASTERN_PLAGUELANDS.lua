...
ns.RegisterGuide({
    ...
    name = "42. Eastern Plaguelands 54-55 (Skyborne)",
    version = 2,
    faction = "Horde",
    race = { "Skyborne" },
    minLevel = 54,
    ...
    next = "GEN_HORDE_SKYBORNE_43_WINTERSPRING",
    author = "ForeverGuide route planner",
    notes = "Chapter 42 of the Skyborne route: level 54 to 55, 34 steps, ~150 min of play in the model (57048 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
