-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_NIGHTELF_18_SWAMP_OF_SORROWS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_ALLIANCE_NIGHTELF_18_SWAMP_OF_SORROWS",
    name = "18. Swamp of Sorrows 38-40 (Night Elf)",
    version = 2,
    faction = "Alliance",
    race = { "NightElf" },
    minLevel = 38,
    ...
    notes = "Chapter 18 of the NightElf route: level 38 to 40, 21 steps, ~237 min of play in the model (5203 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
