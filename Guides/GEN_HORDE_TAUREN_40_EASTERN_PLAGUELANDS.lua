...
ns.RegisterGuide({
    ...
    name = "40. Eastern Plaguelands 51-51 (Tauren)",
    version = 2,
    faction = "Horde",
    race = { "Tauren" },
    minLevel = 51,
    ...
    next = "GEN_HORDE_TAUREN_41_WINTERSPRING",
    author = "ForeverGuide route planner",
    notes = "Chapter 40 of the Tauren route: level 51 to 51, 16 steps, ~88 min of play in the model (38194 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
