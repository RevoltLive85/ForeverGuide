-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_SKYBORNE_43_EASTERN_PLAGUELANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_SKYBORNE_43_EASTERN_PLAGUELANDS",
    name = "43. Eastern Plaguelands 55-55 (Skyborne)",
    version = 2,
    faction = "Horde",
    race = { "Skyborne" },
    minLevel = 55,
    ...
    next = "GEN_HORDE_SKYBORNE_44_BURNING_STEPPES",
    author = "ForeverGuide route planner",
    notes = "Chapter 43 of the Skyborne route: level 55 to 55, 34 steps, ~149 min of play in the model (56785 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
