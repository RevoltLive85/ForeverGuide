-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_SKYBORNE_20_THE_HINTERLANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_ALLIANCE_SKYBORNE_20_THE_HINTERLANDS",
    name = "20. The Hinterlands 41-44 (Skyborne)",
    version = 2,
    faction = "Alliance",
    race = { "Skyborne" },
    minLevel = 41,
    ...
    next = "GEN_ALLIANCE_SKYBORNE_21_IRONFORGE",
    author = "ForeverGuide route planner",
    notes = "Chapter 20 of the Skyborne route: level 41 to 44, 19 steps, ~459 min of play in the model (3446 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
