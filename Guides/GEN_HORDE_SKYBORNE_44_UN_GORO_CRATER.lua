-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_SKYBORNE_44_UN_GORO_CRATER.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_SKYBORNE_44_UN_GORO_CRATER",
    name = "44. Un'Goro Crater 56-56 (Skyborne)",
    version = 2,
    faction = "Horde",
    race = { "Skyborne" },
    minLevel = 56,
    ...
    map = 1449,
    zone = "Un'Goro Crater",
    next = "GEN_HORDE_SKYBORNE_45_UNDERCITY",
    author = "ForeverGuide route planner",
    notes = "Chapter 44 of the Skyborne route: level 56 to 56, 13 steps, ~54 min of play in the model (26887 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 13,
