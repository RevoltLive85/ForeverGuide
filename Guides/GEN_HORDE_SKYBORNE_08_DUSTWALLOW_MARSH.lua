-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_SKYBORNE_08_DUSTWALLOW_MARSH.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_SKYBORNE_08_DUSTWALLOW_MARSH",
    name = "8. Dustwallow Marsh 34-35 (Skyborne)",
    version = 2,
    faction = "Horde",
    race = { "Skyborne" },
    minLevel = 34,
    ...
    notes = "Chapter 8 of the Skyborne route: level 34 to 35, 39 steps, ~117 min of play in the model (30760 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
