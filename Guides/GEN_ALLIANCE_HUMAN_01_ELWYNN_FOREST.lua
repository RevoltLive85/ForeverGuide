...
ns.RegisterGuide({
    ...
    notes = "Chapter 1 of the Human route: level 1 to 11, 106 steps, ~153 min of play in the model (13912 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
        ...
        { type = "ACCEPT", quest = 47, questName = "Gold Dust Exchange", npc = 241, npcName = "Remy \"Two Times\"", map = 1429, zone = "Elwynn Forest", x = 42.1, y = 67.3 }, -- 27
        ...
        { type = "KILL", quest = 99143, questName = "Bottles and Baubles", target = "Murloc", map = 1429, zone = "Elwynn Forest", x = 50.8, y = 65.5, near = true, note = "Shiny Junk (6)" }, -- 32
        { type = "TURNIN", quest = 99143, questName = "Bottles and Baubles", map = 1429, zone = "Elwynn Forest", x = 47.6, y = 62.3 }, -- 33
        ...
        { type = "ACCEPT", quest = 40, questName = "A Fishy Peril", npc = 241, npcName = "Remy \"Two Times\"", map = 1429, zone = "Elwynn Forest", x = 42.1, y = 67.3 }, -- 36
        { type = "TURNIN", quest = 47, questName = "Gold Dust Exchange", npc = 241, npcName = "Remy \"Two Times\"", map = 1429, zone = "Elwynn Forest", x = 42.1, y = 67.3 }, -- 37
        { type = "TURNIN", quest = 40, questName = "A Fishy Peril", npc = 240, npcName = "Marshal Dughan", map = 1429, zone = "Elwynn Forest", x = 42.1, y = 65.9 }, -- 38
        { type = "TURNIN", quest = 54, questName = "Report to Goldshire", npc = 240, npcName = "Marshal Dughan", map = 1429, zone = "Elwynn Forest", x = 42.1, y = 65.9 }, -- 39
        ...
        { type = "COMPLETE", quest = 99127, questName = "A Net Disaster", target = "Half-Eaten Fish (7)", map = 1429, zone = "Elwynn Forest", x = 47.7, y = 65.9, near = true, note = "Half-Eaten Fish (7)" }, -- 41
        { type = "TURNIN", quest = 99127, questName = "A Net Disaster", map = 1429, zone = "Elwynn Forest", x = 47.5, y = 62.2 }, -- 42
        { type = "ACCEPT", quest = 99128, questName = "Slimy Menace", map = 1429, zone = "Elwynn Forest", x = 47.5, y = 62.2 }, -- 43
        { type = "KILL", quest = 99128, questName = "Slimy Menace", target = "Murloc / Murloc", map = 1429, zone = "Elwynn Forest", x = 50.8, y = 65.5, near = true, note = "Murloc Streamrunners slain (4)" }, -- 44
        { type = "TURNIN", quest = 99128, questName = "Slimy Menace", map = 1429, zone = "Elwynn Forest", x = 47.5, y = 62.2 }, -- 45
        { type = "COMPLETE", quest = 62, questName = "The Fargodeep Mine", target = "Scout through the Fargodeep Mine", map = 1429, zone = "Elwynn Forest", x = 40.6, y = 82.3, note = "Scout through the Fargodeep Mine" }, -- 46
        ...
        { type = "COLLECT", quest = 11, questName = "Riverpaw Gnoll Bounty", target = "Painted Gnoll Armband", count = 8, map = 1429, zone = "Elwynn Forest", x = 27.5, y = 79.9, near = true }, -- 64
        { type = "TURNIN", quest = 11, questName = "Riverpaw Gnoll Bounty", npc = 963, npcName = "Deputy Rainer", map = 1429, zone = "Elwynn Forest", x = 24.2, y = 74.5 }, -- 65
        { type = "TURNIN", quest = 111, questName = "Speak with Gramma", npc = 248, npcName = "Gramma Stonefield", map = 1429, zone = "Elwynn Forest", x = 34.9, y = 83.9 }, -- 66
        { type = "ACCEPT", quest = 107, questName = "Note to William", npc = 248, npcName = "Gramma Stonefield", map = 1429, zone = "Elwynn Forest", x = 34.9, y = 83.9 }, -- 67
