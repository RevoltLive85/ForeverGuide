...
ns.RegisterGuide({
    ...
    notes = "Chapter 26 of the Skyborne route: level 48 to 49, 7 steps, ~32 min of play in the model (32053 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 7,
