-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_ORC_08_ARATHI_HIGHLANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_ORC_08_ARATHI_HIGHLANDS",
    name = "8. Arathi Highlands 29-30 (Orc)",
    version = 2,
    faction = "Horde",
    race = { "Orc", "Troll" },
    minLevel = 29,
    ...
    next = "GEN_HORDE_ORC_09_STRANGLETHORN_VALE",
    author = "ForeverGuide route planner",
    notes = "Chapter 8 of the Orc route: level 29 to 30, 41 steps, ~141 min of play in the model (24486 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
        ...
        { type = "ACCEPT", quest = 677, questName = "Call to Arms", npc = 2771, npcName = "Drum Fel", map = 1417, zone = "Arathi Highlands", x = 74.2, y = 33.9 }, -- 23
        { type = "ACCEPT", quest = 671, questName = "Foul Magics", npc = 2706, npcName = "Tor'gan", map = 1417, zone = "Arathi Highlands", x = 74.7, y = 36.3 }, -- 24
