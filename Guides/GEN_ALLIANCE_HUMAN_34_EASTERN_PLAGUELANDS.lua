-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_HUMAN_34_EASTERN_PLAGUELANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_ALLIANCE_HUMAN_34_EASTERN_PLAGUELANDS",
    name = "34. Eastern Plaguelands 49-50 (Human)",
    version = 2,
    faction = "Alliance",
    race = { "Human" },
    minLevel = 49,
    ...
    next = "GEN_ALLIANCE_HUMAN_35_WESTERN_PLAGUELANDS",
    author = "ForeverGuide route planner",
    notes = "Chapter 34 of the Human route: level 49 to 50, 14 steps, ~42 min of play in the model (43128 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
