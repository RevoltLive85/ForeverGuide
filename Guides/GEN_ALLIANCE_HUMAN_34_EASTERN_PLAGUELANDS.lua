...
ns.RegisterGuide({
    ...
    name = "34. Eastern Plaguelands 50-51 (Human)",
    version = 2,
    faction = "Alliance",
    race = { "Human" },
    minLevel = 50,
    ...
    notes = "Chapter 34 of the Human route: level 50 to 51, 14 steps, ~40 min of play in the model (44286 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
