-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_SKYBORNE_34_AZSHARA.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_SKYBORNE_34_AZSHARA",
    name = "34. Azshara 50-51 (Skyborne)",
    version = 2,
    faction = "Horde",
    race = { "Skyborne" },
    minLevel = 50,
    ...
    notes = "Chapter 34 of the Skyborne route: level 50 to 51, 10 steps, ~143 min of play in the model (38135 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
        { type = "GRIND", npc = 6195, target = "Spitelash Siren", level = 51, map = 1447, zone = "Azshara", x = 36.1, y = 50.1, near = true, note = "grind Spitelash Siren (level 50-52) to level 51 - nothing worth questing at 50" }, -- 1
