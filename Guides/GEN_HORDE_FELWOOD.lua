-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_FELWOOD.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_FELWOOD",
    name = "Felwood 48-55 (Horde)",
    version = 1,
    faction = "Horde",
    minLevel = 48,
    maxLevel = 55,
    ...
    steps = {
        ...
        { type = "COLLECT", quest = 4505, questName = "Well of Corruption", target = "Filled Flasket", map = 1448, zone = "Felwood", x = 32.3, y = 66.6 }, -- 16
        { type = "TURNIN", quest = 4505, questName = "Well of Corruption", npc = 9996, npcName = "Winna Hazzard", map = 1448, zone = "Felwood", x = 34.2, y = 52.3 }, -- 17
        ...
        { type = "TURNIN", quest = 8481, questName = "The Root of All Evil", npc = 11555, npcName = "Gorn One Eye", map = 1448, zone = "Felwood", x = 65.2, y = 2.7 }, -- 37
        { type = "ACCEPT", quest = 6031, questName = "Runecloth", npc = 11557, npcName = "Meilosh", map = 1448, zone = "Felwood", x = 65.7, y = 2.8 }, -- 38
        { type = "ACCEPT", quest = 8485, questName = "The Brokering of Peace", npc = 11555, npcName = "Gorn One Eye", map = 1448, zone = "Felwood", x = 65.2, y = 2.7 }, -- 39
        { type = "TURNIN", quest = 6031, questName = "Runecloth", npc = 11557, npcName = "Meilosh", map = 1448, zone = "Felwood", x = 65.7, y = 2.8 }, -- 40
        { type = "TURNIN", quest = 8485, questName = "The Brokering of Peace", npc = 4949, npcName = "Thrall", map = 1454, zone = "Orgrimmar", x = 31.7, y = 37.8 }, -- 41
        { type = "TURNIN", quest = 8465, questName = "Speak to Salfa", npc = 11556, npcName = "Salfa", map = 1452, zone = "Winterspring", x = 27.7, y = 34.5 }, -- 42
        { type = "TURNIN", quest = 5158, questName = "Seeking Spiritual Aid", npc = 5901, npcName = "Islen Waterseer", map = 1413, zone = "The Barrens", x = 65.8, y = 43.8 }, -- 43
    },
})
