-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_DWARF_13_DESOLACE.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_ALLIANCE_DWARF_13_DESOLACE",
    name = "13. Desolace 34-35 (Dwarf)",
    version = 2,
    faction = "Alliance",
    race = { "Dwarf", "Gnome" },
    minLevel = 34,
    ...
    map = 1443,
    zone = "Desolace",
    next = "GEN_ALLIANCE_DWARF_14_BADLANDS",
    author = "ForeverGuide route planner",
    notes = "Chapter 13 of the Dwarf route: level 34 to 35, 69 steps, ~226 min of play in the model (28803 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
        ...
        { type = "TURNIN", quest = 1387, questName = "Centaur Bounty", npc = 5752, npcName = "Corporal Melkins", map = 1443, zone = "Desolace", x = 66.7, y = 10.9 }, -- 14
