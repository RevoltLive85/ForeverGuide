...
ns.RegisterGuide({
    ...
    next = "GEN_ALLIANCE_NIGHTELF_46_WESTERN_PLAGUELANDS",
    author = "ForeverGuide route planner",
    notes = "Chapter 45 of the NightElf route: level 55 to 55, 42 steps, ~170 min of play in the model (58430 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
