-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_DWARF_17_SWAMP_OF_SORROWS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_ALLIANCE_DWARF_17_SWAMP_OF_SORROWS",
    name = "17. Swamp of Sorrows 38-40 (Dwarf)",
    version = 2,
    faction = "Alliance",
    race = { "Dwarf", "Gnome" },
    minLevel = 38,
    ...
    next = "GEN_ALLIANCE_DWARF_18_FERALAS",
    author = "ForeverGuide route planner",
    notes = "Chapter 17 of the Dwarf route: level 38 to 40, 21 steps, ~244 min of play in the model (5053 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
