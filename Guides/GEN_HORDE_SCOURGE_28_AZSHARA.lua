-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_SCOURGE_28_AZSHARA.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_SCOURGE_28_AZSHARA",
    name = "28. Azshara 48-49 (Undead)",
    version = 2,
    faction = "Horde",
    race = { "Scourge" },
    minLevel = 48,
    ...
    notes = "Chapter 28 of the Scourge route: level 48 to 49, 7 steps, ~32 min of play in the model (32053 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 7,
