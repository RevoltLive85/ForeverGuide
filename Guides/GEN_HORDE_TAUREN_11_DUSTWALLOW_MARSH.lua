...
ns.RegisterGuide({
    ...
    name = "11. Dustwallow Marsh 36-37 (Tauren)",
    version = 2,
    faction = "Horde",
    race = { "Tauren" },
    minLevel = 36,
    ...
    next = "GEN_HORDE_TAUREN_12_FERALAS",
    author = "ForeverGuide route planner",
    notes = "Chapter 11 of the Tauren route: level 36 to 37, 61 steps, ~204 min of play in the model (31983 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
        ...
        { type = "COLLECT", quest = 1322, questName = "The Black Shield", target = "Acidic Venom Sac", count = 6, map = 1445, zone = "Dustwallow Marsh", x = 34.3, y = 28, near = true }, -- 28
        ...
        { type = "ACCEPT", quest = 1166, questName = "Overlord Mok'Morokk's Concern", npc = 4500, npcName = "Overlord Mok'Morokk", map = 1445, zone = "Dustwallow Marsh", x = 36.3, y = 31.4 }, -- 35
        { type = "ACCEPT", quest = 1168, questName = "Army of the Black Dragon", npc = 4502, npcName = "Tharg", map = 1445, zone = "Dustwallow Marsh", x = 37.4, y = 31.4 }, -- 36
        { type = "ACCEPT", quest = 1169, questName = "Identifying the Brood", npc = 4501, npcName = "Draz'Zilb", map = 1445, zone = "Dustwallow Marsh", x = 37.2, y = 33.1 }, -- 37
        { type = "KILL", quest = 1168, questName = "Army of the Black Dragon", npc = 4329, target = "Firemane Scout", count = 10, map = 1445, zone = "Dustwallow Marsh", x = 39, y = 64.6, near = true }, -- 38
        { type = "COLLECT", quest = 1166, questName = "Overlord Mok'Morokk's Concern", target = "Mok'Morokk's Grog", map = 1445, zone = "Dustwallow Marsh", x = 38.7, y = 65.6 }, -- 39
        { type = "KILL", quest = 1168, questName = "Army of the Black Dragon", npc = 4331, target = "Firemane Ash Tail / Firemane Scalebane", count = 10, map = 1445, zone = "Dustwallow Marsh", x = 39.4, y = 66.6, near = true }, -- 40
        { type = "COLLECT", quest = 1166, questName = "Overlord Mok'Morokk's Concern", target = "Mok'Morokk's Strongbox", map = 1445, zone = "Dustwallow Marsh", x = 36.6, y = 69.6 }, -- 41
        { type = "COLLECT", quest = 1169, questName = "Identifying the Brood", target = "Searing Tongue / Searing Heart", count = 15, map = 1445, zone = "Dustwallow Marsh", x = 37.4, y = 74.2, near = true }, -- 42
        { type = "COLLECT", quest = 1166, questName = "Overlord Mok'Morokk's Concern", target = "Mok'Morokk's Snuff", map = 1445, zone = "Dustwallow Marsh", x = 44.5, y = 66 }, -- 43
        { type = "TURNIN", quest = 1169, questName = "Identifying the Brood", npc = 4501, npcName = "Draz'Zilb", map = 1445, zone = "Dustwallow Marsh", x = 37.2, y = 33.1 }, -- 44
        { type = "ACCEPT", quest = 1170, questName = "The Brood of Onyxia", npc = 4501, npcName = "Draz'Zilb", map = 1445, zone = "Dustwallow Marsh", x = 37.2, y = 33.1 }, -- 45
        { type = "TURNIN", quest = 1168, questName = "Army of the Black Dragon", npc = 4502, npcName = "Tharg", map = 1445, zone = "Dustwallow Marsh", x = 37.4, y = 31.4 }, -- 46
        { type = "TURNIN", quest = 1166, questName = "Overlord Mok'Morokk's Concern", npc = 4500, npcName = "Overlord Mok'Morokk", map = 1445, zone = "Dustwallow Marsh", x = 36.3, y = 31.4 }, -- 47
        { type = "TURNIN", quest = 1170, questName = "The Brood of Onyxia", npc = 4500, npcName = "Overlord Mok'Morokk", map = 1445, zone = "Dustwallow Marsh", x = 36.3, y = 31.4 }, -- 48
        { type = "ACCEPT", quest = 1171, questName = "The Brood of Onyxia", npc = 4500, npcName = "Overlord Mok'Morokk", map = 1445, zone = "Dustwallow Marsh", x = 36.3, y = 31.4 }, -- 49
        { type = "TURNIN", quest = 1171, questName = "The Brood of Onyxia", npc = 4501, npcName = "Draz'Zilb", map = 1445, zone = "Dustwallow Marsh", x = 37.2, y = 33.1 }, -- 50
        { type = "ACCEPT", quest = 1172, questName = "The Brood of Onyxia", npc = 4501, npcName = "Draz'Zilb", map = 1445, zone = "Dustwallow Marsh", x = 37.2, y = 33.1 }, -- 51
