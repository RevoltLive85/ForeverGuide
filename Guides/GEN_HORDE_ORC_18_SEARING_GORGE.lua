...
ns.RegisterGuide({
    ...
    notes = "Chapter 18 of the Orc route: level 45 to 45, 26 steps, ~106 min of play in the model (39495 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 26,
