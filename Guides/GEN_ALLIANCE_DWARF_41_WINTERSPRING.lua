...
ns.RegisterGuide({
    ...
    name = "41. Winterspring 53-54 (Dwarf)",
    version = 2,
    faction = "Alliance",
    race = { "Dwarf", "Gnome" },
    minLevel = 53,
    ...
    map = 1452,
    zone = "Winterspring",
    next = "GEN_ALLIANCE_DWARF_42_SILITHUS",
    author = "ForeverGuide route planner",
    notes = "Chapter 41 of the Dwarf route: level 53 to 54, 13 steps, ~232 min of play in the model (4558 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
