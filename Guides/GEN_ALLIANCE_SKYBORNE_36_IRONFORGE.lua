-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_SKYBORNE_36_IRONFORGE.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_ALLIANCE_SKYBORNE_36_IRONFORGE",
    name = "36. Ironforge 51-51 (Skyborne)",
    version = 2,
    faction = "Alliance",
    race = { "Skyborne" },
    minLevel = 51,
    ...
    map = 1455,
    zone = "Ironforge",
    next = "GEN_ALLIANCE_SKYBORNE_37_BURNING_STEPPES",
    author = "ForeverGuide route planner",
    notes = "Chapter 36 of the Skyborne route: level 51 to 51, 10 steps, ~26 min of play in the model (53781 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 10,
