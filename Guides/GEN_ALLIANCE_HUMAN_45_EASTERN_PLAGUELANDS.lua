-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_HUMAN_45_EASTERN_PLAGUELANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_ALLIANCE_HUMAN_45_EASTERN_PLAGUELANDS",
    name = "45. Eastern Plaguelands 55-55 (Human)",
    version = 2,
    faction = "Alliance",
    race = { "Human" },
    minLevel = 55,
    ...
    notes = "Chapter 45 of the Human route: level 55 to 55, 42 steps, ~178 min of play in the model (55810 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 42,
