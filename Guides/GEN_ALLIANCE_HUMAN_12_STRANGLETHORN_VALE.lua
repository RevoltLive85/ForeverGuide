...
ns.RegisterGuide({
    ...
    next = "GEN_ALLIANCE_HUMAN_13_DUSTWALLOW_MARSH",
    author = "ForeverGuide route planner",
    notes = "Chapter 12 of the Human route: level 29 to 33, 109 steps, ~360 min of play in the model (27688 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
