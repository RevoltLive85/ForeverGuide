-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_TAUREN_19_THE_HINTERLANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_TAUREN_19_THE_HINTERLANDS",
    name = "19. The Hinterlands 43-44 (Tauren)",
    version = 2,
    faction = "Horde",
    race = { "Tauren" },
    minLevel = 43,
    ...
    next = "GEN_HORDE_TAUREN_20_SEARING_GORGE",
    author = "ForeverGuide route planner",
    notes = "Chapter 19 of the Tauren route: level 43 to 44, 42 steps, ~192 min of play in the model (39798 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
