-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_ORC_32_BURNING_STEPPES.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_ORC_32_BURNING_STEPPES",
    name = "32. Burning Steppes 49-50 (Orc)",
    version = 2,
    faction = "Horde",
    race = { "Orc", "Troll" },
    minLevel = 49,
    ...
    next = "GEN_HORDE_ORC_33_THE_HINTERLANDS",
    author = "ForeverGuide route planner",
    notes = "Chapter 32 of the Orc route: level 49 to 50, 10 steps, ~110 min of play in the model (40966 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
