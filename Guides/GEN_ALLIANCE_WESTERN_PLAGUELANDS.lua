-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_WESTERN_PLAGUELANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_ALLIANCE_WESTERN_PLAGUELANDS",
    name = "Western Plaguelands 51-58 (Alliance)",
    version = 1,
    faction = "Alliance",
    minLevel = 51,
    maxLevel = 58,
    ...
    next = "GEN_ALLIANCE_EASTERN_PLAGUELANDS",
    author = "ForeverGuide route generator",
    notes = "Auto-generated from the quest database: 31 quests, 85 steps, model reaches level 55. Not a speedrun route - a sensible order; the engine adapts as you play.",
    steps = {
        ...
        { type = "TURNIN", quest = 5215, questName = "The Scourge Cauldrons", npc = 11053, npcName = "High Priestess MacDonnell", map = 1422, zone = "Western Plaguelands", x = 43, y = 84.5 }, -- 8
        { type = "ACCEPT", quest = 5216, questName = "Target: Felstone Field", npc = 11053, npcName = "High Priestess MacDonnell", map = 1422, zone = "Western Plaguelands", x = 43, y = 84.5 }, -- 9
        { type = "KILL", quest = 5097, questName = "All Along the Watchtowers", npc = 10902, target = "Andorhal Tower One", map = 1422, zone = "Western Plaguelands", x = 40.1, y = 71.6, note = "Tower One marked" }, -- 10
        { type = "KILL", quest = 5097, questName = "All Along the Watchtowers", npc = 10903, target = "Andorhal Tower Two", map = 1422, zone = "Western Plaguelands", x = 42.3, y = 66.2, note = "Tower Two marked" }, -- 11
        { type = "KILL", quest = 5097, questName = "All Along the Watchtowers", npc = 10904, target = "Andorhal Tower Three", map = 1422, zone = "Western Plaguelands", x = 44.3, y = 63.3, note = "Tower Three marked" }, -- 12
        { type = "KILL", quest = 5097, questName = "All Along the Watchtowers", npc = 10905, target = "Andorhal Tower Four", map = 1422, zone = "Western Plaguelands", x = 46.6, y = 71.1, note = "Tower Four marked" }, -- 13
        { type = "TURNIN", quest = 5097, questName = "All Along the Watchtowers", npc = 10838, npcName = "Commander Ashlam Valorfist", map = 1422, zone = "Western Plaguelands", x = 42.7, y = 84 }, -- 14
        { type = "ACCEPT", quest = 211, questName = "Alas, Andorhal", npc = 10838, npcName = "Commander Ashlam Valorfist", map = 1422, zone = "Western Plaguelands", x = 42.7, y = 84 }, -- 15
        ...
        { type = "KILL", quest = 6023, questName = "Unfinished Business", npc = 11613, target = "Huntsman Radley", map = 1422, zone = "Western Plaguelands", x = 57.8, y = 36.1 }, -- 48
        { type = "TURNIN", quest = 6023, questName = "Unfinished Business", npc = 11610, npcName = "Kirsta Deepshadow", map = 1422, zone = "Western Plaguelands", x = 51.9, y = 28.1 }, -- 49
        { type = "ACCEPT", quest = 6025, questName = "Unfinished Business", npc = 11610, npcName = "Kirsta Deepshadow", map = 1422, zone = "Western Plaguelands", x = 51.9, y = 28.1 }, -- 50
        ...
        { type = "KILL", quest = 5222, questName = "Target: Writhing Haunt", npc = 11076, target = "Cauldron Lord Razarch", map = 1422, zone = "Western Plaguelands", x = 52.9, y = 66.1, note = "loot Writhing Haunt Cauldron Key" }, -- 61
        { type = "TURNIN", quest = 5222, questName = "Target: Writhing Haunt", map = 1422, zone = "Western Plaguelands", x = 53, y = 65.6 }, -- 62
        { type = "ACCEPT", quest = 5223, questName = "Return to Chillwind Camp", map = 1422, zone = "Western Plaguelands", x = 53, y = 65.6 }, -- 63
        { type = "TURNIN", quest = 5223, questName = "Return to Chillwind Camp", npc = 11053, npcName = "High Priestess MacDonnell", map = 1422, zone = "Western Plaguelands", x = 43, y = 84.5 }, -- 64
        { type = "ACCEPT", quest = 5225, questName = "Target: Gahrron's Withering", npc = 11053, npcName = "High Priestess MacDonnell", map = 1422, zone = "Western Plaguelands", x = 43, y = 84.5 }, -- 65
        { type = "KILL", quest = 5225, questName = "Target: Gahrron's Withering", npc = 11078, target = "Cauldron Lord Soulwrath", map = 1422, zone = "Western Plaguelands", x = 62.2, y = 59.1, note = "loot Gahrron's Withering Cauldron Key" }, -- 66
        { type = "TURNIN", quest = 5225, questName = "Target: Gahrron's Withering", map = 1422, zone = "Western Plaguelands", x = 62.5, y = 58.5 }, -- 67
        { type = "ACCEPT", quest = 5226, questName = "Return to Chillwind Point", map = 1422, zone = "Western Plaguelands", x = 62.5, y = 58.5 }, -- 68
        { type = "TURNIN", quest = 5226, questName = "Return to Chillwind Point", npc = 11053, npcName = "High Priestess MacDonnell", map = 1422, zone = "Western Plaguelands", x = 43, y = 84.5 }, -- 69
        { type = "ACCEPT", quest = 5237, questName = "Mission Accomplished!", npc = 10838, npcName = "Commander Ashlam Valorfist", map = 1422, zone = "Western Plaguelands", x = 42.7, y = 84 }, -- 70
        { type = "TURNIN", quest = 5237, questName = "Mission Accomplished!", npc = 10838, npcName = "Commander Ashlam Valorfist", map = 1422, zone = "Western Plaguelands", x = 42.7, y = 84 }, -- 71
        { type = "TURNIN", quest = 5022, questName = "Better Late Than Never", npc = 10782, npcName = "Royal Factor Bathrilor", map = 1453, zone = "Stormwind City", x = 48.5, y = 30.5 }, -- 72
        { type = "TURNIN", quest = 4986, questName = "Glyphed Oaken Branch", npc = 4217, npcName = "Mathrengyl Bearwalker", map = 1457, zone = "Darnassus", x = 35.4, y = 8.4 }, -- 73
        { type = "GRIND", level = 55, note = "the next quests need level 55" }, -- 74
        { type = "ACCEPT", quest = 5533, questName = "Scholomance", npc = 10838, npcName = "Commander Ashlam Valorfist", map = 1422, zone = "Western Plaguelands", x = 42.7, y = 84 }, -- 75
        { type = "ACCEPT", quest = 5507, questName = "Mantles of the Dawn", npc = 10857, npcName = "Argent Quartermaster Lightspark", map = 1422, zone = "Western Plaguelands", x = 42.8, y = 83.7 }, -- 76
        { type = "ACCEPT", quest = 5521, questName = "Chromatic Mantle of the Dawn", npc = 10857, npcName = "Argent Quartermaster Lightspark", map = 1422, zone = "Western Plaguelands", x = 42.8, y = 83.7 }, -- 77
        { type = "TURNIN", quest = 5533, questName = "Scholomance", npc = 11056, npcName = "Alchemist Arbington", map = 1422, zone = "Western Plaguelands", x = 42.7, y = 83.8 }, -- 78
