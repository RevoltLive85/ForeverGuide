...
ns.RegisterGuide({
    ...
    name = "18. Swamp of Sorrows 38-39 (Human)",
    version = 2,
    faction = "Alliance",
    race = { "Human" },
    minLevel = 38,
    ...
    notes = "Chapter 18 of the Human route: level 38 to 39, 20 steps, ~96 min of play in the model (12871 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
