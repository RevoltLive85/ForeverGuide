-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_DWARF_25_FELWOOD.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_ALLIANCE_DWARF_25_FELWOOD",
    name = "25. Felwood 46-46 (Dwarf)",
    version = 2,
    faction = "Alliance",
    race = { "Dwarf", "Gnome" },
    minLevel = 46,
    ...
    map = 1448,
    zone = "Felwood",
    next = "GEN_ALLIANCE_DWARF_26_FERALAS",
    author = "ForeverGuide route planner",
    notes = "Chapter 25 of the Dwarf route: level 46 to 46, 14 steps, ~72 min of play in the model (24836 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
