...
ns.RegisterGuide({
    ...
    notes = "Chapter 18 of the NightElf route: level 38 to 40, 72 steps, ~220 min of play in the model (26891 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
        ...
        { type = "GRIND", npc = 11937, target = "Demon Portal Guardian", level = 40, map = 1443, zone = "Desolace", x = 55, y = 79.6, near = true, note = "grind Demon Portal Guardian (level 38-39) to level 40 - nothing worth questing at 39" }, -- 72
    },
})
