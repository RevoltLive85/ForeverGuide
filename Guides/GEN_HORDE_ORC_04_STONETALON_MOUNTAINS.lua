-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_ORC_04_STONETALON_MOUNTAINS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_ORC_04_STONETALON_MOUNTAINS",
    name = "4. Stonetalon Mountains 24-25 (Orc)",
    version = 2,
    faction = "Horde",
    race = { "Orc", "Troll" },
    minLevel = 24,
    ...
    next = "GEN_HORDE_ORC_05_ASHENVALE",
    author = "ForeverGuide route planner",
    notes = "Chapter 4 of the Orc route: level 24 to 25, 41 steps, ~155 min of play in the model (20691 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
