-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_ORC_30_EASTERN_PLAGUELANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_ORC_30_EASTERN_PLAGUELANDS",
    name = "30. Eastern Plaguelands 50-50 (Orc)",
    version = 2,
    faction = "Horde",
    race = { "Orc", "Troll" },
    minLevel = 50,
    ...
    next = "GEN_HORDE_ORC_31_BURNING_STEPPES",
    author = "ForeverGuide route planner",
    notes = "Chapter 30 of the Orc route: level 50 to 50, 14 steps, ~40 min of play in the model (44266 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
