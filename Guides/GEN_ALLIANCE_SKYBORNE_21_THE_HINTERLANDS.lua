-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_SKYBORNE_21_THE_HINTERLANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_ALLIANCE_SKYBORNE_21_THE_HINTERLANDS",
    name = "21. The Hinterlands 42-45 (Skyborne)",
    version = 2,
    faction = "Alliance",
    race = { "Skyborne" },
    minLevel = 42,
    ...
    next = "GEN_ALLIANCE_SKYBORNE_22_IRONFORGE",
    author = "ForeverGuide route planner",
    notes = "Chapter 21 of the Skyborne route: level 42 to 45, 19 steps, ~504 min of play in the model (3114 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
