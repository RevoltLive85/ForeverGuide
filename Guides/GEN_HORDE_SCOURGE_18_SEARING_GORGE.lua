-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_SCOURGE_18_SEARING_GORGE.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_SCOURGE_18_SEARING_GORGE",
    name = "18. Searing Gorge 44-44 (Undead)",
    version = 2,
    faction = "Horde",
    race = { "Scourge" },
    minLevel = 44,
    ...
    map = 1427,
    zone = "Searing Gorge",
    next = "GEN_HORDE_SCOURGE_19_BLASTED_LANDS",
    author = "ForeverGuide route planner",
    notes = "Chapter 18 of the Scourge route: level 44 to 44, 26 steps, ~112 min of play in the model (37937 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
