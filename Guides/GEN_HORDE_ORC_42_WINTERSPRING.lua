...
ns.RegisterGuide({
    ...
    notes = "Chapter 42 of the Orc route: level 56 to 56, 27 steps, ~90 min of play in the model (44792 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps (1 here).",
    stepCount = 27,
