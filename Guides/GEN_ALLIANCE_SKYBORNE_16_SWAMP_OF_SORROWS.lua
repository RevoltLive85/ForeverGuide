-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_SKYBORNE_16_SWAMP_OF_SORROWS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_ALLIANCE_SKYBORNE_16_SWAMP_OF_SORROWS",
    name = "16. Swamp of Sorrows 38-39 (Skyborne)",
    version = 2,
    faction = "Alliance",
    race = { "Skyborne" },
    minLevel = 38,
    ...
    next = "GEN_ALLIANCE_SKYBORNE_17_TANARIS",
    author = "ForeverGuide route planner",
    notes = "Chapter 16 of the Skyborne route: level 38 to 39, 20 steps, ~81 min of play in the model (15161 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
