...
ns.RegisterGuide({
    ...
    name = "37. Eastern Plaguelands 51-51 (Undead)",
    version = 2,
    faction = "Horde",
    race = { "Scourge" },
    minLevel = 51,
    ...
    next = "GEN_HORDE_SCOURGE_38_UN_GORO_CRATER",
    author = "ForeverGuide route planner",
    notes = "Chapter 37 of the Scourge route: level 51 to 51, 6 steps, ~15 min of play in the model (35837 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
