...
ns.RegisterGuide({
    ...
    next = "GEN_HORDE_SCOURGE_38_WINTERSPRING",
    author = "ForeverGuide route planner",
    notes = "Chapter 37 of the Scourge route: level 51 to 51, 16 steps, ~88 min of play in the model (38194 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
