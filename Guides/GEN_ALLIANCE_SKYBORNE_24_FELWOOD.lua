-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_SKYBORNE_24_FELWOOD.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_ALLIANCE_SKYBORNE_24_FELWOOD",
    name = "24. Felwood 45-45 (Skyborne)",
    version = 2,
    faction = "Alliance",
    race = { "Skyborne" },
    minLevel = 45,
    ...
    map = 1448,
    zone = "Felwood",
    next = "GEN_ALLIANCE_SKYBORNE_25_FERALAS",
    author = "ForeverGuide route planner",
    notes = "Chapter 24 of the Skyborne route: level 45 to 45, 14 steps, ~74 min of play in the model (24494 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
