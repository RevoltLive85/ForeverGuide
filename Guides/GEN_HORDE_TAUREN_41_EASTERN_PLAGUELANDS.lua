...
ns.RegisterGuide({
    ...
    name = "41. Eastern Plaguelands 55-55 (Tauren)",
    version = 2,
    faction = "Horde",
    race = { "Tauren" },
    minLevel = 55,
    ...
    next = "GEN_HORDE_TAUREN_42_BURNING_STEPPES",
    author = "ForeverGuide route planner",
    notes = "Chapter 41 of the Tauren route: level 55 to 55, 34 steps, ~154 min of play in the model (54940 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 34,
