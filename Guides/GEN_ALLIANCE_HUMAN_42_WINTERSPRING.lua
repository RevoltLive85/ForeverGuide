...
ns.RegisterGuide({
    ...
    name = "42. Winterspring 53-54 (Human)",
    version = 2,
    faction = "Alliance",
    race = { "Human" },
    minLevel = 53,
    ...
    notes = "Chapter 42 of the Human route: level 53 to 54, 23 steps, ~260 min of play in the model (11223 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 23,
