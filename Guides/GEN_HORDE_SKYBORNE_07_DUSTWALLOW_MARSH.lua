-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_SKYBORNE_07_DUSTWALLOW_MARSH.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_SKYBORNE_07_DUSTWALLOW_MARSH",
    name = "7. Dustwallow Marsh 33-34 (Skyborne)",
    version = 2,
    faction = "Horde",
    race = { "Skyborne" },
    minLevel = 33,
    ...
    next = "GEN_HORDE_SKYBORNE_08_BADLANDS",
    author = "ForeverGuide route planner",
    notes = "Chapter 7 of the Skyborne route: level 33 to 34, 39 steps, ~121 min of play in the model (29928 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
        ...
        { type = "ACCEPT", quest = 1239, questName = "The Severed Head", map = 1445, zone = "Dustwallow Marsh", x = 55.4, y = 25.9 }, -- 35
        { type = "TURNIN", quest = 1239, questName = "The Severed Head", npc = 4791, npcName = "Nazeer Bloodpike", map = 1445, zone = "Dustwallow Marsh", x = 35.2, y = 30.7 }, -- 36
