...
ns.RegisterGuide({
    ...
    name = "39. Eastern Plaguelands 51-51 (Human)",
    version = 2,
    faction = "Alliance",
    race = { "Human" },
    minLevel = 51,
    ...
    next = "GEN_ALLIANCE_HUMAN_40_FELWOOD",
    author = "ForeverGuide route planner",
    notes = "Chapter 39 of the Human route: level 51 to 51, 20 steps, ~103 min of play in the model (37972 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
