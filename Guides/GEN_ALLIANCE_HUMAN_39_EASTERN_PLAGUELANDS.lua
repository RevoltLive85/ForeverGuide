-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_HUMAN_39_EASTERN_PLAGUELANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_ALLIANCE_HUMAN_39_EASTERN_PLAGUELANDS",
    name = "39. Eastern Plaguelands 52-52 (Human)",
    version = 2,
    faction = "Alliance",
    race = { "Human" },
    minLevel = 52,
    ...
    next = "GEN_ALLIANCE_HUMAN_40_WINTERSPRING",
    author = "ForeverGuide route planner",
    notes = "Chapter 39 of the Human route: level 52 to 52, 20 steps, ~98 min of play in the model (39384 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
