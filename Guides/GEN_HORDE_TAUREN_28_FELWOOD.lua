-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_TAUREN_28_FELWOOD.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_TAUREN_28_FELWOOD",
    name = "28. Felwood 47-48 (Tauren)",
    version = 2,
    faction = "Horde",
    race = { "Tauren" },
    minLevel = 47,
    ...
    map = 1448,
    zone = "Felwood",
    next = "GEN_HORDE_TAUREN_29_UN_GORO_CRATER",
    author = "ForeverGuide route planner",
    notes = "Chapter 28 of the Tauren route: level 47 to 48, 22 steps, ~88 min of play in the model (41266 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
