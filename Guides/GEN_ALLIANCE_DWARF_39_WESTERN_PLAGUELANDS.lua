-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_DWARF_39_WESTERN_PLAGUELANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_ALLIANCE_DWARF_39_WESTERN_PLAGUELANDS",
    name = "39. Western Plaguelands 51-51 (Dwarf)",
    version = 2,
    faction = "Alliance",
    race = { "Dwarf", "Gnome" },
    minLevel = 51,
    ...
    next = "GEN_ALLIANCE_DWARF_40_EASTERN_PLAGUELANDS",
    author = "ForeverGuide route planner",
    notes = "Chapter 39 of the Dwarf route: level 51 to 51, 8 steps, ~41 min of play in the model (38536 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
