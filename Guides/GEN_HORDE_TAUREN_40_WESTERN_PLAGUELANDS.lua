-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_TAUREN_40_WESTERN_PLAGUELANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_TAUREN_40_WESTERN_PLAGUELANDS",
    name = "40. Western Plaguelands 53-54 (Tauren)",
    version = 2,
    faction = "Horde",
    race = { "Tauren" },
    minLevel = 53,
    ...
    notes = "Chapter 40 of the Tauren route: level 53 to 54, 13 steps, ~266 min of play in the model (7867 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
