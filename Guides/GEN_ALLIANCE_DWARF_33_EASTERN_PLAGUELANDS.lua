-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_DWARF_33_EASTERN_PLAGUELANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_ALLIANCE_DWARF_33_EASTERN_PLAGUELANDS",
    name = "33. Eastern Plaguelands 50-51 (Dwarf)",
    version = 2,
    faction = "Alliance",
    race = { "Dwarf", "Gnome" },
    minLevel = 50,
    ...
    notes = "Chapter 33 of the Dwarf route: level 50 to 51, 14 steps, ~40 min of play in the model (44286 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
