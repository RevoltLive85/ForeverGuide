-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_SKYBORNE_32_EASTERN_PLAGUELANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_ALLIANCE_SKYBORNE_32_EASTERN_PLAGUELANDS",
    name = "32. Eastern Plaguelands 49-50 (Skyborne)",
    version = 2,
    faction = "Alliance",
    race = { "Skyborne" },
    minLevel = 49,
    ...
    notes = "Chapter 32 of the Skyborne route: level 49 to 50, 14 steps, ~42 min of play in the model (43128 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
