-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_SCOURGE_44_EASTERN_PLAGUELANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_SCOURGE_44_EASTERN_PLAGUELANDS",
    name = "44. Eastern Plaguelands 55-55 (Undead)",
    version = 2,
    faction = "Horde",
    race = { "Scourge" },
    minLevel = 55,
    ...
    next = "GEN_HORDE_SCOURGE_45_BURNING_STEPPES",
    author = "ForeverGuide route planner",
    notes = "Chapter 44 of the Scourge route: level 55 to 55, 34 steps, ~149 min of play in the model (56785 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
