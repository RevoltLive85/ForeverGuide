-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_ORC_14_FERALAS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_ORC_14_FERALAS",
    name = "14. Feralas 41-42 (Orc)",
    version = 2,
    faction = "Horde",
    race = { "Orc", "Troll" },
    minLevel = 41,
    ...
    map = 1444,
    zone = "Feralas",
    next = "GEN_HORDE_ORC_15_DESOLACE",
    author = "ForeverGuide route planner",
    notes = "Chapter 14 of the Orc route: level 41 to 42, 44 steps, ~174 min of play in the model (38643 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
