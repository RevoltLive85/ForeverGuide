-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_TAUREN_47_EASTERN_PLAGUELANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_TAUREN_47_EASTERN_PLAGUELANDS",
    name = "47. Eastern Plaguelands 54-55 (Tauren)",
    version = 2,
    faction = "Horde",
    race = { "Tauren" },
    minLevel = 54,
    ...
    next = "GEN_HORDE_TAUREN_48_WINTERSPRING",
    author = "ForeverGuide route planner",
    notes = "Chapter 47 of the Tauren route: level 54 to 55, 34 steps, ~150 min of play in the model (57048 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
