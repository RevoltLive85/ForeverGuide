...
ns.RegisterGuide({
    ...
    name = "8. Stranglethorn Vale 28-29 (Tauren)",
    version = 2,
    faction = "Horde",
    race = { "Tauren" },
    minLevel = 28,
    ...
    next = "GEN_HORDE_TAUREN_09_ARATHI_HIGHLANDS",
    author = "ForeverGuide route planner",
    notes = "Chapter 8 of the Tauren route: level 28 to 29, 37 steps, ~122 min of play in the model (22499 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
