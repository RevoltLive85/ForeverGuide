-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_TAUREN_45_UN_GORO_CRATER.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_TAUREN_45_UN_GORO_CRATER",
    name = "45. Un'Goro Crater 56-56 (Tauren)",
    version = 2,
    faction = "Horde",
    race = { "Tauren" },
    minLevel = 56,
    ...
    map = 1449,
    zone = "Un'Goro Crater",
    next = "GEN_HORDE_TAUREN_46_UNDERCITY",
    author = "ForeverGuide route planner",
    notes = "Chapter 45 of the Tauren route: level 56 to 56, 13 steps, ~54 min of play in the model (26887 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 13,
