-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_NIGHTELF_22_IRONFORGE.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_ALLIANCE_NIGHTELF_22_IRONFORGE",
    name = "22. Ironforge 44-44 (Night Elf)",
    version = 2,
    faction = "Alliance",
    race = { "NightElf" },
    minLevel = 44,
    ...
    notes = "Chapter 22 of the NightElf route: level 44 to 44, 9 steps, ~22 min of play in the model (44470 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
        ...
        { type = "TURNIN", quest = 1050, questName = "Mythology of the Titans", npc = 3979, npcName = "Librarian Mae Paledust", map = 1455, zone = "Ironforge", x = 75, y = 12.5, note = "reduced xp (80%) - you out-levelled it" }, -- 4
