-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_ORC_24_FELWOOD.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_ORC_24_FELWOOD",
    name = "24. Felwood 47-48 (Orc)",
    version = 2,
    faction = "Horde",
    race = { "Orc", "Troll" },
    minLevel = 47,
    ...
    notes = "Chapter 24 of the Orc route: level 47 to 48, 22 steps, ~88 min of play in the model (41111 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
