-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_ORC_31_BURNING_STEPPES.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_ORC_31_BURNING_STEPPES",
    name = "31. Burning Steppes 50-51 (Orc)",
    version = 2,
    faction = "Horde",
    race = { "Orc", "Troll" },
    minLevel = 50,
    ...
    notes = "Chapter 31 of the Orc route: level 50 to 51, 8 steps, ~160 min of play in the model (39833 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
