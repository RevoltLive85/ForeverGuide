-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_SKYBORNE_39_EASTERN_PLAGUELANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_ALLIANCE_SKYBORNE_39_EASTERN_PLAGUELANDS",
    name = "39. Eastern Plaguelands 52-53 (Skyborne)",
    version = 2,
    faction = "Alliance",
    race = { "Skyborne" },
    minLevel = 52,
    ...
    next = "GEN_ALLIANCE_SKYBORNE_40_WESTERN_PLAGUELANDS",
    author = "ForeverGuide route planner",
    notes = "Chapter 39 of the Skyborne route: level 52 to 53, 21 steps, ~212 min of play in the model (18103 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
