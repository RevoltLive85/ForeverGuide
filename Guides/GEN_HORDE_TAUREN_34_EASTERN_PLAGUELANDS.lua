-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_TAUREN_34_EASTERN_PLAGUELANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_TAUREN_34_EASTERN_PLAGUELANDS",
    name = "34. Eastern Plaguelands 49-49 (Tauren)",
    version = 2,
    faction = "Horde",
    race = { "Tauren" },
    minLevel = 49,
    ...
    next = "GEN_HORDE_TAUREN_35_AZSHARA",
    author = "ForeverGuide route planner",
    notes = "Chapter 34 of the Tauren route: level 49 to 49, 14 steps, ~42 min of play in the model (43110 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
