...
ns.RegisterGuide({
    ...
    notes = "Chapter 40 of the Dwarf route: level 52 to 52, 8 steps, ~41 min of play in the model (39039 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 8,
