...
ns.RegisterGuide({
    ...
    name = "38. Eastern Plaguelands 50-50 (Tauren)",
    version = 2,
    faction = "Horde",
    race = { "Tauren" },
    minLevel = 50,
    ...
    next = "GEN_HORDE_TAUREN_39_AZSHARA",
    author = "ForeverGuide route planner",
    notes = "Chapter 38 of the Tauren route: level 50 to 50, 6 steps, ~15 min of play in the model (35837 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
