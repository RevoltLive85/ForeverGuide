...
ns.RegisterGuide({
    ...
    name = "42. Eastern Plaguelands 54-55 (Undead)",
    version = 2,
    faction = "Horde",
    race = { "Scourge" },
    minLevel = 54,
    ...
    notes = "Chapter 42 of the Scourge route: level 54 to 55, 34 steps, ~158 min of play in the model (54332 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
