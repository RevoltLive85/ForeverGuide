-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_SCOURGE_17_THE_HINTERLANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_SCOURGE_17_THE_HINTERLANDS",
    name = "17. The Hinterlands 43-44 (Undead)",
    version = 2,
    faction = "Horde",
    race = { "Scourge" },
    minLevel = 43,
    ...
    next = "GEN_HORDE_SCOURGE_18_SEARING_GORGE",
    author = "ForeverGuide route planner",
    notes = "Chapter 17 of the Scourge route: level 43 to 44, 37 steps, ~198 min of play in the model (35998 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
