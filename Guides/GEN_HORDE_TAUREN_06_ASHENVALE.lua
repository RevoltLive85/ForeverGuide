-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_TAUREN_06_ASHENVALE.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_TAUREN_06_ASHENVALE",
    name = "6. Ashenvale 26-27 (Tauren)",
    version = 2,
    faction = "Horde",
    race = { "Tauren" },
    minLevel = 26,
    ...
    map = 1440,
    zone = "Ashenvale",
    next = "GEN_HORDE_TAUREN_07_THOUSAND_NEEDLES",
    author = "ForeverGuide route planner",
    notes = "Chapter 6 of the Tauren route: level 26 to 27, 39 steps, ~116 min of play in the model (22870 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
