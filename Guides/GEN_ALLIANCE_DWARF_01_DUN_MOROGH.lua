...
ns.RegisterGuide({
    ...
    steps = {
        ...
        { type = "KILL", quest = 182, questName = "The Troll Cave", npc = 706, target = "Frostmane Troll Whelp", count = 14, map = 1426, zone = "Dun Morogh", x = 26.8, y = 79, near = true }, -- 17
        { type = "TURNIN", quest = 182, questName = "The Troll Cave", npc = 786, npcName = "Grelin Whitebeard", map = 1426, zone = "Dun Morogh", x = 25.1, y = 75.7 }, -- 18
        { type = "ACCEPT", quest = 218, questName = "The Stolen Journal", npc = 786, npcName = "Grelin Whitebeard", map = 1426, zone = "Dun Morogh", x = 25.1, y = 75.7 }, -- 19
        { type = "KILL", quest = 218, questName = "The Stolen Journal", npc = 808, target = "Grik'nir the Cold", map = 1426, zone = "Dun Morogh", x = 30.5, y = 80.2, note = "loot Grelin Whitebeard's Journal" }, -- 20
        { type = "TURNIN", quest = 218, questName = "The Stolen Journal", npc = 786, npcName = "Grelin Whitebeard", map = 1426, zone = "Dun Morogh", x = 25.1, y = 75.7 }, -- 21
        { type = "ACCEPT", quest = 282, questName = "Senir's Observations", npc = 786, npcName = "Grelin Whitebeard", map = 1426, zone = "Dun Morogh", x = 25.1, y = 75.7 }, -- 22
        { type = "TURNIN", quest = 3364, questName = "Scalding Mornbrew Delivery", npc = 836, npcName = "Durnan Furcutter", map = 1426, zone = "Dun Morogh", x = 28.8, y = 66.4 }, -- 23
        { type = "ACCEPT", quest = 3365, questName = "Bring Back the Mug", npc = 836, npcName = "Durnan Furcutter", map = 1426, zone = "Dun Morogh", x = 28.8, y = 66.4 }, -- 24
        { type = "TURNIN", quest = 282, questName = "Senir's Observations", npc = 1965, npcName = "Mountaineer Thalos", map = 1426, zone = "Dun Morogh", x = 33.5, y = 71.8 }, -- 25
        { type = "ACCEPT", quest = 420, questName = "Senir's Observations", npc = 1965, npcName = "Mountaineer Thalos", map = 1426, zone = "Dun Morogh", x = 33.5, y = 71.8 }, -- 26
        { type = "TURNIN", quest = 3365, questName = "Bring Back the Mug", npc = 12738, npcName = "Nori Pridedrift", map = 1426, zone = "Dun Morogh", x = 25, y = 76 }, -- 27
        { type = "ACCEPT", quest = 310, questName = "Bitter Rivals", npc = 1375, npcName = "Marleth Barleybrew", map = 1426, zone = "Dun Morogh", x = 30.2, y = 45.5 }, -- 28
