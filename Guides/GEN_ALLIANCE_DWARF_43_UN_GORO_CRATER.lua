...
ns.RegisterGuide({
    ...
    name = "43. Un'Goro Crater 54-55 (Dwarf)",
    version = 2,
    faction = "Alliance",
    race = { "Dwarf", "Gnome" },
    minLevel = 54,
    ...
    map = 1449,
    zone = "Un'Goro Crater",
    next = "GEN_ALLIANCE_DWARF_44_EASTERN_PLAGUELANDS",
    author = "ForeverGuide route planner",
    notes = "Chapter 43 of the Dwarf route: level 54 to 55, 14 steps, ~78 min of play in the model (18956 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
