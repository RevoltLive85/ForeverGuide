...
ns.RegisterGuide({
    ...
    notes = "Chapter 26 of the NightElf route: level 47 to 47, 16 steps, ~48 min of play in the model (31295 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
