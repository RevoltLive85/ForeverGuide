...
ns.RegisterGuide({
    ...
    notes = "Chapter 17 of the Orc route: level 44 to 45, 42 steps, ~188 min of play in the model (40226 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
