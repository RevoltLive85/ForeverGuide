...
ns.RegisterGuide({
    ...
    notes = "Chapter 22 of the Human route: level 42 to 45, 18 steps, ~473 min of play in the model (10475 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
