...
ns.RegisterGuide({
    ...
    notes = "Chapter 32 of the NightElf route: level 48 to 49, 8 steps, ~91 min of play in the model (8726 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps (1 here).",
    stepCount = 8,
