...
ns.RegisterGuide({
    ...
    name = "19. Swamp of Sorrows 38-39 (Dwarf)",
    version = 2,
    faction = "Alliance",
    race = { "Dwarf", "Gnome" },
    minLevel = 38,
    ...
    notes = "Chapter 19 of the Dwarf route: level 38 to 39, 20 steps, ~87 min of play in the model (14168 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
