...
ns.RegisterGuide({
    ...
    name = "48. Winterspring 56-58 (Night Elf)",
    version = 2,
    faction = "Alliance",
    race = { "NightElf" },
    minLevel = 56,
    ...
    map = 1452,
    zone = "Winterspring",
    next = "GEN_ALLIANCE_NIGHTELF_49_SILITHUS",
    author = "ForeverGuide route planner",
    notes = "Chapter 48 of the NightElf route: level 56 to 58, 9 steps, ~549 min of play in the model (1981 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
