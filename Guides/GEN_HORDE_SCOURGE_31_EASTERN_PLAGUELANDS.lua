-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_SCOURGE_31_EASTERN_PLAGUELANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_SCOURGE_31_EASTERN_PLAGUELANDS",
    name = "31. Eastern Plaguelands 49-49 (Undead)",
    version = 2,
    faction = "Horde",
    race = { "Scourge" },
    minLevel = 49,
    ...
    next = "GEN_HORDE_SCOURGE_32_BURNING_STEPPES",
    author = "ForeverGuide route planner",
    notes = "Chapter 31 of the Scourge route: level 49 to 49, 14 steps, ~49 min of play in the model (37190 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
