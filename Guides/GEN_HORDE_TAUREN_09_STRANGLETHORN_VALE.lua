-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_TAUREN_09_STRANGLETHORN_VALE.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_TAUREN_09_STRANGLETHORN_VALE",
    name = "9. Stranglethorn Vale 30-36 (Tauren)",
    version = 2,
    faction = "Horde",
    race = { "Tauren" },
    minLevel = 30,
    ...
    next = "GEN_HORDE_TAUREN_10_BADLANDS",
    author = "ForeverGuide route planner",
    notes = "Chapter 9 of the Tauren route: level 30 to 36, 97 steps, ~854 min of play in the model (25842 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
