-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_DWARF_11_STRANGLETHORN_VALE.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_ALLIANCE_DWARF_11_STRANGLETHORN_VALE",
    name = "11. Stranglethorn Vale 29-32 (Dwarf)",
    version = 2,
    faction = "Alliance",
    race = { "Dwarf", "Gnome" },
    minLevel = 29,
    ...
    next = "GEN_ALLIANCE_DWARF_12_DUSTWALLOW_MARSH",
    author = "ForeverGuide route planner",
    notes = "Chapter 11 of the Dwarf route: level 29 to 32, 109 steps, ~361 min of play in the model (27606 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
