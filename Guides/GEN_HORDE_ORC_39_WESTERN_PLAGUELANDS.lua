...
ns.RegisterGuide({
    ...
    name = "39. Western Plaguelands 52-53 (Orc)",
    version = 2,
    faction = "Horde",
    race = { "Orc", "Troll" },
    minLevel = 52,
    ...
    notes = "Chapter 39 of the Orc route: level 52 to 53, 13 steps, ~263 min of play in the model (8013 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
