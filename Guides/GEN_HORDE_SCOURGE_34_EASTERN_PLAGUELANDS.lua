-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_SCOURGE_34_EASTERN_PLAGUELANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_SCOURGE_34_EASTERN_PLAGUELANDS",
    name = "34. Eastern Plaguelands 50-50 (Undead)",
    version = 2,
    faction = "Horde",
    race = { "Scourge" },
    minLevel = 50,
    ...
    next = "GEN_HORDE_SCOURGE_35_BURNING_STEPPES",
    author = "ForeverGuide route planner",
    notes = "Chapter 34 of the Scourge route: level 50 to 50, 14 steps, ~40 min of play in the model (44266 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 14,
