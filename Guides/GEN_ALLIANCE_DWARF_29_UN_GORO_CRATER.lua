-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_DWARF_29_UN_GORO_CRATER.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_ALLIANCE_DWARF_29_UN_GORO_CRATER",
    name = "29. Un'Goro Crater 46-46 (Dwarf)",
    version = 2,
    faction = "Alliance",
    race = { "Dwarf", "Gnome" },
    minLevel = 46,
    ...
    map = 1449,
    zone = "Un'Goro Crater",
    next = "GEN_ALLIANCE_DWARF_30_TANARIS",
    author = "ForeverGuide route planner",
    notes = "Chapter 29 of the Dwarf route: level 46 to 46, 27 steps, ~74 min of play in the model (39406 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
