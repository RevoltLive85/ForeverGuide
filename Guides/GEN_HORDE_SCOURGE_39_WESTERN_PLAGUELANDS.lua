-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_SCOURGE_39_WESTERN_PLAGUELANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_SCOURGE_39_WESTERN_PLAGUELANDS",
    name = "39. Western Plaguelands 52-53 (Undead)",
    version = 2,
    faction = "Horde",
    race = { "Scourge" },
    minLevel = 52,
    ...
    next = "GEN_HORDE_SCOURGE_40_EASTERN_PLAGUELANDS",
    author = "ForeverGuide route planner",
    notes = "Chapter 39 of the Scourge route: level 52 to 53, 13 steps, ~263 min of play in the model (8013 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
