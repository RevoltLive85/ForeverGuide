-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_TAUREN_20_SEARING_GORGE.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_TAUREN_20_SEARING_GORGE",
    name = "20. Searing Gorge 44-45 (Tauren)",
    version = 2,
    faction = "Horde",
    race = { "Tauren" },
    minLevel = 44,
    ...
    map = 1427,
    zone = "Searing Gorge",
    next = "GEN_HORDE_TAUREN_21_BLASTED_LANDS",
    author = "ForeverGuide route planner",
    notes = "Chapter 20 of the Tauren route: level 44 to 45, 26 steps, ~112 min of play in the model (37937 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
