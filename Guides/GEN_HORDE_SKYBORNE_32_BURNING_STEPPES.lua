-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_SKYBORNE_32_BURNING_STEPPES.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_SKYBORNE_32_BURNING_STEPPES",
    name = "32. Burning Steppes 50-51 (Skyborne)",
    version = 2,
    faction = "Horde",
    race = { "Skyborne" },
    minLevel = 50,
    ...
    next = "GEN_HORDE_SKYBORNE_33_THE_HINTERLANDS",
    author = "ForeverGuide route planner",
    notes = "Chapter 32 of the Skyborne route: level 50 to 51, 8 steps, ~160 min of play in the model (39833 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
