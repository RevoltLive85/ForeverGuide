...
ns.RegisterGuide({
    ...
    name = "37. Western Plaguelands 52-52 (Dwarf)",
    version = 2,
    faction = "Alliance",
    race = { "Dwarf", "Gnome" },
    minLevel = 52,
    ...
    next = "GEN_ALLIANCE_DWARF_38_EASTERN_PLAGUELANDS",
    author = "ForeverGuide route planner",
    notes = "Chapter 37 of the Dwarf route: level 52 to 52, 8 steps, ~41 min of play in the model (39039 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
