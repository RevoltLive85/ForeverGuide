-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_SKYBORNE_17_SWAMP_OF_SORROWS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_ALLIANCE_SKYBORNE_17_SWAMP_OF_SORROWS",
    name = "17. Swamp of Sorrows 38-40 (Skyborne)",
    version = 2,
    faction = "Alliance",
    race = { "Skyborne" },
    minLevel = 38,
    ...
    notes = "Chapter 17 of the Skyborne route: level 38 to 40, 21 steps, ~222 min of play in the model (5547 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
