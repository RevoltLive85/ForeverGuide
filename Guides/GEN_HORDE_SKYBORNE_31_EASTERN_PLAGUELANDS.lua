-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_SKYBORNE_31_EASTERN_PLAGUELANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_SKYBORNE_31_EASTERN_PLAGUELANDS",
    name = "31. Eastern Plaguelands 50-50 (Skyborne)",
    version = 2,
    faction = "Horde",
    race = { "Skyborne" },
    minLevel = 50,
    ...
    next = "GEN_HORDE_SKYBORNE_32_BURNING_STEPPES",
    author = "ForeverGuide route planner",
    notes = "Chapter 31 of the Skyborne route: level 50 to 50, 14 steps, ~40 min of play in the model (44266 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
