...
ns.RegisterGuide({
    ...
    name = "7. Stranglethorn Vale 28-29 (Orc)",
    version = 2,
    faction = "Horde",
    race = { "Orc", "Troll" },
    minLevel = 28,
    ...
    next = "GEN_HORDE_ORC_08_ARATHI_HIGHLANDS",
    author = "ForeverGuide route planner",
    notes = "Chapter 7 of the Orc route: level 28 to 29, 37 steps, ~123 min of play in the model (22445 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
