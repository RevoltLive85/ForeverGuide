...
ns.RegisterGuide({
    ...
    notes = "Chapter 13 of the Skyborne route: level 41 to 42, 44 steps, ~171 min of play in the model (39160 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 44,
