...
ns.RegisterGuide({
    ...
    notes = "Chapter 24 of the Dwarf route: level 45 to 45, 9 steps, ~22 min of play in the model (42575 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 9,
