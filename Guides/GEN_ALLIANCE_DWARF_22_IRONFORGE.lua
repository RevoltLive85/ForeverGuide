-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_DWARF_22_IRONFORGE.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_ALLIANCE_DWARF_22_IRONFORGE",
    name = "22. Ironforge 45-45 (Dwarf)",
    version = 2,
    faction = "Alliance",
    race = { "Dwarf", "Gnome" },
    minLevel = 45,
    ...
    map = 1455,
    zone = "Ironforge",
    next = "GEN_ALLIANCE_DWARF_23_SEARING_GORGE",
    author = "ForeverGuide route planner",
    notes = "Chapter 22 of the Dwarf route: level 45 to 45, 9 steps, ~22 min of play in the model (42575 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
