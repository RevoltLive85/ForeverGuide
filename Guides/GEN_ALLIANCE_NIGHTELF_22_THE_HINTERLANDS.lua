-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_NIGHTELF_22_THE_HINTERLANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_ALLIANCE_NIGHTELF_22_THE_HINTERLANDS",
    name = "22. The Hinterlands 42-45 (Night Elf)",
    version = 2,
    faction = "Alliance",
    race = { "NightElf" },
    minLevel = 42,
    ...
    next = "GEN_ALLIANCE_NIGHTELF_23_SEARING_GORGE",
    author = "ForeverGuide route planner",
    notes = "Chapter 22 of the NightElf route: level 42 to 45, 19 steps, ~504 min of play in the model (3114 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
