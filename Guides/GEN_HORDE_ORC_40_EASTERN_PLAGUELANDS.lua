...
ns.RegisterGuide({
    ...
    name = "40. Eastern Plaguelands 55-55 (Orc)",
    version = 2,
    faction = "Horde",
    race = { "Orc", "Troll" },
    minLevel = 55,
    ...
    next = "GEN_HORDE_ORC_41_BURNING_STEPPES",
    author = "ForeverGuide route planner",
    notes = "Chapter 40 of the Orc route: level 55 to 55, 34 steps, ~154 min of play in the model (54940 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 34,
