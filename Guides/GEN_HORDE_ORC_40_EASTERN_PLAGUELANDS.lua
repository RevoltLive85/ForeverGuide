...
ns.RegisterGuide({
    ...
    notes = "Chapter 40 of the Orc route: level 55 to 55, 34 steps, ~154 min of play in the model (54940 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
