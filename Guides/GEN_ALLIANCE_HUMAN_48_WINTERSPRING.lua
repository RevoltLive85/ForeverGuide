-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_HUMAN_48_WINTERSPRING.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    ...
    notes = "Chapter 48 of the Human route: level 58 to 60, 8 steps, ~566 min of play in the model (1903 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 8,
