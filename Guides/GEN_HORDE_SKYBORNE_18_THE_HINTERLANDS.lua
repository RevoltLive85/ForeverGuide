-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_SKYBORNE_18_THE_HINTERLANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_SKYBORNE_18_THE_HINTERLANDS",
    name = "18. The Hinterlands 44-45 (Skyborne)",
    version = 2,
    faction = "Horde",
    race = { "Skyborne" },
    minLevel = 44,
    ...
    next = "GEN_HORDE_SKYBORNE_19_SEARING_GORGE",
    author = "ForeverGuide route planner",
    notes = "Chapter 18 of the Skyborne route: level 44 to 45, 42 steps, ~198 min of play in the model (38193 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
