...
ns.RegisterGuide({
    ...
    notes = "Chapter 25 of the Orc route: level 48 to 48, 16 steps, ~81 min of play in the model (36565 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
