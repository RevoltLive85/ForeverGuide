-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_ORC_05_ASHENVALE.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_ORC_05_ASHENVALE",
    name = "5. Ashenvale 25-27 (Orc)",
    version = 2,
    faction = "Horde",
    race = { "Orc", "Troll" },
    minLevel = 25,
