...
ns.RegisterGuide({
    ...
    name = "40. Eastern Plaguelands 54-54 (Undead)",
    version = 2,
    faction = "Horde",
    race = { "Scourge" },
    minLevel = 54,
    ...
    notes = "Chapter 40 of the Scourge route: level 54 to 54, 20 steps, ~81 min of play in the model (50154 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 20,
