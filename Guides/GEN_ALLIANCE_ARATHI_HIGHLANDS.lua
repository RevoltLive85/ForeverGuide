-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_ARATHI_HIGHLANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_ALLIANCE_ARATHI_HIGHLANDS",
    name = "Arathi Highlands 30-40 (Alliance)",
    version = 1,
    faction = "Alliance",
    minLevel = 30,
    maxLevel = 40,
    ...
    steps = {
        ...
        { type = "COLLECT", quest = 696, questName = "Attack on the Tower", target = "Trelane's Phylactery / Trelane's Ember Agate / Trelane's Orb", map = 1417, zone = "Arathi Highlands", x = 18.2, y = 68.1 }, -- 38
        { type = "TURNIN", quest = 696, questName = "Attack on the Tower", npc = 2789, npcName = "Skuerto", map = 1417, zone = "Arathi Highlands", x = 46.7, y = 47 }, -- 39
        { type = "ACCEPT", quest = 697, questName = "Malin's Request", npc = 2789, npcName = "Skuerto", map = 1417, zone = "Arathi Highlands", x = 46.7, y = 47 }, -- 40
        { type = "TURNIN", quest = 697, questName = "Malin's Request", npc = 2708, npcName = "Archmage Malin", map = 1453, zone = "Stormwind City", x = 39.8, y = 81.5 }, -- 41
        { type = "TURNIN", quest = 653, questName = "Myzrael's Allies", npc = 2786, npcName = "Gerrig Bonegrip", map = 1455, zone = "Ironforge", x = 50.8, y = 5.6 }, -- 42
        { type = "ACCEPT", quest = 687, questName = "Theldurin the Lost", npc = 2786, npcName = "Gerrig Bonegrip", map = 1455, zone = "Ironforge", x = 50.8, y = 5.6 }, -- 43
        { type = "TURNIN", quest = 687, questName = "Theldurin the Lost", npc = 2785, npcName = "Theldurin the Lost", map = 1418, zone = "Badlands", x = 51.4, y = 76.9 }, -- 44
        { type = "GRIND", level = 35, note = "the next quests need level 35" }, -- 45
        { type = "ACCEPT", quest = 663, questName = "Land Ho!", npc = 2766, npcName = "Lolo the Lookout", map = 1417, zone = "Arathi Highlands", x = 31.8, y = 82.7 }, -- 46
        { type = "TURNIN", quest = 663, questName = "Land Ho!", npc = 2610, npcName = "Shakes O'Breen", map = 1417, zone = "Arathi Highlands", x = 32.3, y = 81.4 }, -- 47
        { type = "ACCEPT", quest = 662, questName = "Deep Sea Salvage", npc = 2767, npcName = "First Mate Nilzlix", map = 1417, zone = "Arathi Highlands", x = 32.8, y = 81.5 }, -- 48
        { type = "ACCEPT", quest = 664, questName = "Drowned Sorrows", npc = 2769, npcName = "Captain Steelgut", map = 1417, zone = "Arathi Highlands", x = 34, y = 80.8 }, -- 49
        { type = "ACCEPT", quest = 665, questName = "Sunken Treasure", npc = 2768, npcName = "Professor Phizzlethorpe", map = 1417, zone = "Arathi Highlands", x = 33.9, y = 80.6 }, -- 50
        ...
        { type = "TURNIN", quest = 664, questName = "Drowned Sorrows", npc = 2769, npcName = "Captain Steelgut", map = 1417, zone = "Arathi Highlands", x = 34, y = 80.8 }, -- 60
        { type = "TURNIN", quest = 666, questName = "Sunken Treasure", npc = 2774, npcName = "Doctor Draxlegauge", map = 1417, zone = "Arathi Highlands", x = 33.9, y = 80.5 }, -- 61
        { type = "ACCEPT", quest = 668, questName = "Sunken Treasure", npc = 2774, npcName = "Doctor Draxlegauge", map = 1417, zone = "Arathi Highlands", x = 33.9, y = 80.5 }, -- 62
        { type = "TURNIN", quest = 668, questName = "Sunken Treasure", npc = 2610, npcName = "Shakes O'Breen", map = 1417, zone = "Arathi Highlands", x = 32.3, y = 81.4 }, -- 63
        { type = "ACCEPT", quest = 669, questName = "Sunken Treasure", npc = 2610, npcName = "Shakes O'Breen", map = 1417, zone = "Arathi Highlands", x = 32.3, y = 81.4 }, -- 64
        { type = "TURNIN", quest = 669, questName = "Sunken Treasure", npc = 2487, npcName = "Fleet Master Seahorn", map = 1434, zone = "Stranglethorn Vale", x = 27.2, y = 77 }, -- 65
    },
})
