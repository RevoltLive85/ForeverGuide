...
ns.RegisterGuide({
    ...
    name = "4. Stonetalon Mountains 17-18 (Human)",
    version = 2,
    faction = "Alliance",
    race = { "Human" },
    minLevel = 17,
    ...
    notes = "Chapter 4 of the Human route: level 17 to 18, 17 steps, ~34 min of play in the model (21534 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
