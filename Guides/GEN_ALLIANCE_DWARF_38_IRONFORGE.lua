...
ns.RegisterGuide({
    ...
    notes = "Chapter 38 of the Dwarf route: level 51 to 51, 10 steps, ~26 min of play in the model (53781 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 10,
