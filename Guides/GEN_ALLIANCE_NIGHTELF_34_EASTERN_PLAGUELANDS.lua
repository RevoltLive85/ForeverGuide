-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_NIGHTELF_34_EASTERN_PLAGUELANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_ALLIANCE_NIGHTELF_34_EASTERN_PLAGUELANDS",
    name = "34. Eastern Plaguelands 50-51 (Night Elf)",
    version = 2,
    faction = "Alliance",
    race = { "NightElf" },
    minLevel = 50,
    ...
    next = "GEN_ALLIANCE_NIGHTELF_35_WESTERN_PLAGUELANDS",
    author = "ForeverGuide route planner",
    notes = "Chapter 34 of the NightElf route: level 50 to 51, 14 steps, ~40 min of play in the model (44286 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
