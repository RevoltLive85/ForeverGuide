...
ns.RegisterGuide({
    ...
    next = "GEN_HORDE_SKYBORNE_36_WINTERSPRING",
    author = "ForeverGuide route planner",
    notes = "Chapter 35 of the Skyborne route: level 51 to 51, 16 steps, ~88 min of play in the model (38194 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
