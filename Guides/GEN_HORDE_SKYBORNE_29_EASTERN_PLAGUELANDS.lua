-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_SKYBORNE_29_EASTERN_PLAGUELANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_SKYBORNE_29_EASTERN_PLAGUELANDS",
    name = "29. Eastern Plaguelands 49-49 (Skyborne)",
    version = 2,
    faction = "Horde",
    race = { "Skyborne" },
    minLevel = 49,
    ...
    next = "GEN_HORDE_SKYBORNE_30_FELWOOD",
    author = "ForeverGuide route planner",
    notes = "Chapter 29 of the Skyborne route: level 49 to 49, 14 steps, ~42 min of play in the model (43110 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
