...
ns.RegisterGuide({
    ...
    name = "18. Searing Gorge 44-44 (Skyborne)",
    version = 2,
    faction = "Horde",
    race = { "Skyborne" },
    minLevel = 44,
    ...
    notes = "Chapter 18 of the Skyborne route: level 44 to 44, 26 steps, ~112 min of play in the model (37937 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
