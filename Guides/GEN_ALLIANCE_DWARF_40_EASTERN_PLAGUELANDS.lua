-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_DWARF_40_EASTERN_PLAGUELANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_ALLIANCE_DWARF_40_EASTERN_PLAGUELANDS",
    name = "40. Eastern Plaguelands 51-51 (Dwarf)",
    version = 2,
    faction = "Alliance",
    race = { "Dwarf", "Gnome" },
    minLevel = 51,
    ...
    notes = "Chapter 40 of the Dwarf route: level 51 to 51, 20 steps, ~103 min of play in the model (37972 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
