-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_ORC_37_WESTERN_PLAGUELANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_ORC_37_WESTERN_PLAGUELANDS",
    name = "37. Western Plaguelands 53-54 (Orc)",
    version = 2,
    faction = "Horde",
    race = { "Orc", "Troll" },
    minLevel = 53,
