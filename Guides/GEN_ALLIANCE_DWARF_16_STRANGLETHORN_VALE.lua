-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_DWARF_16_STRANGLETHORN_VALE.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_ALLIANCE_DWARF_16_STRANGLETHORN_VALE",
    name = "16. Stranglethorn Vale 37-38 (Dwarf)",
    version = 2,
    faction = "Alliance",
    race = { "Dwarf", "Gnome" },
    minLevel = 37,
    ...
    next = "GEN_ALLIANCE_DWARF_17_SWAMP_OF_SORROWS",
    author = "ForeverGuide route planner",
    notes = "Chapter 16 of the Dwarf route: level 37 to 38, 32 steps, ~143 min of play in the model (28217 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
