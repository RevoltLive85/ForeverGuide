-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_SKYBORNE_22_IRONFORGE.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_ALLIANCE_SKYBORNE_22_IRONFORGE",
    name = "22. Ironforge 45-45 (Skyborne)",
    version = 2,
    faction = "Alliance",
    race = { "Skyborne" },
    minLevel = 45,
    ...
    map = 1455,
    zone = "Ironforge",
    next = "GEN_ALLIANCE_SKYBORNE_23_SEARING_GORGE",
    author = "ForeverGuide route planner",
    notes = "Chapter 22 of the Skyborne route: level 45 to 45, 9 steps, ~22 min of play in the model (42575 xp/h). Route tuned for xp per hour: low-value quests, elites and long escorts are skipped on purpose.",
    steps = {
